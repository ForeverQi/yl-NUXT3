!function(e, t) {
    ...
    function c(e, a) {
        var r = [];
        return null == e ? r : Array.prototype.map && e.map === Array.prototype.map ? e.map(a) : (s(e, function(e, t, n) {
            r.push(a(e, t, n))
        }),
            r)
    }
    ...
    var e = {
        ...
        try {
            ...
            i.shaderSource(r, "attribute vec2 attrVertex;varying vec2 varyinTexCoordinate;uniform vec2 uniformOffset;void main(){varyinTexCoordinate=attrVertex+uniformOffset;gl_Position=vec4(attrVertex,0,1);}"),
                i.compileShader(r);
            n = i.createShader(i.FRAGMENT_SHADER);
            i.shaderSource(n, "precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor=vec4(varyinTexCoordinate,0,1);}"),
                i.compileShader(n),
                i.attachShader(a, r),
                i.attachShader(a, n),
                i.linkProgram(a),
                i.useProgram(a),
                a.vertexPosAttrib = i.getAttribLocation(a, "attrVertex"),
                a.offsetUniform = i.getUniformLocation(a, "uniformOffset"),
                i.enableVertexAttribArray(a.vertexPosArray),
                i.vertexAttribPointer(a.vertexPosAttrib, t.itemSize, i.FLOAT, !1, 0, 0),
                i.uniform2f(a.offsetUniform, 1, 1),
                i.drawArrays(i.TRIANGLE_STRIP, 0, t.numItems);
            try {
                o.push(i.canvas.toDataURL())
            } catch (e) {}
            o.push("extensions:" + (i.getSupportedExtensions() || []).join(";")),
                o.push("webgl aliased line width range:" + e(i.getParameter(i.ALIASED_LINE_WIDTH_RANGE))),
                o.push("webgl aliased point size range:" + e(i.getParameter(i.ALIASED_POINT_SIZE_RANGE))),
                o.push("webgl alpha bits:" + i.getParameter(i.ALPHA_BITS)),
                o.push("webgl antialiasing:" + (i.getContextAttributes().antialias ? "yes" : "no")),
                o.push("webgl blue bits:" + i.getParameter(i.BLUE_BITS)),
                o.push("webgl depth bits:" + i.getParameter(i.DEPTH_BITS)),
                o.push("webgl green bits:" + i.getParameter(i.GREEN_BITS)),
                ...
                o.push("webgl max combined texture image units:" + i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS)),
                o.push("webgl max cube map texture size:" + i.getParameter(i.MAX_CUBE_MAP_TEXTURE_SIZE)),
                o.push("webgl max fragment uniform vectors:" + i.getParameter(i.MAX_FRAGMENT_UNIFORM_VECTORS)),
                o.push("webgl max render buffer size:" + i.getParameter(i.MAX_RENDERBUFFER_SIZE)),
                o.push("webgl max texture image units:" + i.getParameter(i.MAX_TEXTURE_IMAGE_UNITS)),
                o.push("webgl max texture size:" + i.getParameter(i.MAX_TEXTURE_SIZE)),
                o.push("webgl max varying vectors:" + i.getParameter(i.MAX_VARYING_VECTORS)),
                o.push("webgl max vertex attribs:" + i.getParameter(i.MAX_VERTEX_ATTRIBS)),
                o.push("webgl max vertex texture image units:" + i.getParameter(i.MAX_VERTEX_TEXTURE_IMAGE_UNITS)),
                o.push("webgl max vertex uniform vectors:" + i.getParameter(i.MAX_VERTEX_UNIFORM_VECTORS)),
                o.push("webgl max viewport dims:" + e(i.getParameter(i.MAX_VIEWPORT_DIMS))),
                o.push("webgl red bits:" + i.getParameter(i.RED_BITS)),
                o.push("webgl renderer:" + i.getParameter(i.RENDERER)),
                o.push("webgl shading language version:" + i.getParameter(i.SHADING_LANGUAGE_VERSION)),
                o.push("webgl stencil bits:" + i.getParameter(i.STENCIL_BITS)),
                o.push("webgl vendor:" + i.getParameter(i.VENDOR)),
                o.push("webgl version:" + i.getParameter(i.VERSION));
            try {
                var l = i.getExtension("WEBGL_debug_renderer_info");
                l && (o.push("webgl unmasked vendor:" + i.getParameter(l.UNMASKED_VENDOR_WEBGL)),
                    o.push("webgl unmasked renderer:" + i.getParameter(l.UNMASKED_RENDERER_WEBGL)))
            } catch (e) {}
            return i.getShaderPrecisionFormat ? (s(["FLOAT", "INT"], function(r) {
                s(["VERTEX", "FRAGMENT"], function(a) {
                    s(["HIGH", "MEDIUM", "LOW"], function(n) {
                        s(["precision", "rangeMin", "rangeMax"], function(e) {
                            var t = i.getShaderPrecisionFormat(i[a + "_SHADER"], i[n + "_" + r])[e];
                            "precision" !== e && (e = "precision " + e);
                            t = ["webgl ", a.toLowerCase(), " shader ", n.toLowerCase(), " ", r.toLowerCase(), " ", e, ":", t].join("");
                            o.push(t)
                        })
                    })
                })
        ...
        var e = navigator.userAgent.toLowerCase()
            ...
            , a = 0 <= e.indexOf("windows phone") ? "Windows Phone" : 0 <= e.indexOf("windows") || 0 <= e.indexOf("win16") || 0 <= e.indexOf("win32") || 0 <= e.indexOf("win64") || 0 <= e.indexOf("win95") || 0 <= e.indexOf("win98") || 0 <= e.indexOf("winnt") || 0 <= e.indexOf("wow64") ? "Windows" : 0 <= e.indexOf("android") ? "Android" : 0 <= e.indexOf("linux") || 0 <= e.indexOf("cros") || 0 <= e.indexOf("x11") ? "Linux" : 0 <= e.indexOf("iphone") || 0 <= e.indexOf("ipad") || 0 <= e.indexOf("ipod") || 0 <= e.indexOf("crios") || 0 <= e.indexOf("fxios") ? "iOS" : 0 <= e.indexOf("macintosh") || 0 <= e.indexOf("mac_powerpc)") ? "Mac" : "Other";
        if (("ontouchstart"in window || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints) && "Windows" !== a && "Windows Phone" !== a && "Android" !== a && "iOS" !== a && "Other" !== a && -1 === e.indexOf("cros"))
            return !0;
        if (void 0 !== t) {
            if (0 <= (t = t.toLowerCase()).indexOf("win") && "Windows" !== a && "Windows Phone" !== a)
                return !0;
            if (0 <= t.indexOf("linux") && "Linux" !== a && "Android" !== a)
                return !0;
            if (0 <= t.indexOf("mac") && "Mac" !== a && "iOS" !== a)
                return !0;
            if ((-1 === t.indexOf("win") && -1 === t.indexOf("linux") && -1 === t.indexOf("mac")) != ("Other" === a))
                return !0
        }
        return 0 <= n.indexOf("win") && "Windows" !== a && "Windows Phone" !== a || ((0 <= n.indexOf("linux") || 0 <= n.indexOf("android") || 0 <= n.indexOf("pike")) && "Linux" !== a && "Android" !== a || ((0 <= n.indexOf("mac") || 0 <= n.indexOf("ipad") || 0 <= n.indexOf("ipod") || 0 <= n.indexOf("iphone")) && "Mac" !== a && "iOS" !== a || !(0 <= n.indexOf("arm") && "Windows Phone" === a) && (!(0 <= n.indexOf("pike") && 0 <= e.indexOf("opera mini")) && ((n.indexOf("win") < 0 && n.indexOf("linux") < 0 && n.indexOf("mac") < 0 && n.indexOf("iphone") < 0 && n.indexOf("ipad") < 0 && n.indexOf("ipod") < 0) != ("Other" === a) || void 0 === navigator.plugins && "Windows" !== a && "Windows Phone" !== a))))
    }
        , I = function() {
        var e = navigator.userAgent.toLowerCase()
        ...
        if (0 <= e.indexOf("opera mini"))
            return !1;
        if (("Chrome" === (e = 0 <= e.indexOf("firefox/") ? "Firefox" : 0 <= e.indexOf("opera/") || 0 <= e.indexOf(" opr/") ? "Opera" : 0 <= e.indexOf("chrome/") ? "Chrome" : 0 <= e.indexOf("safari/") ? 0 <= e.indexOf("android 1.") || 0 <= e.indexOf("android 2.") || 0 <= e.indexOf("android 3.") || 0 <= e.indexOf("android 4.") ? "AOSP" : "Safari" : 0 <= e.indexOf("trident/") ? "Internet Explorer" : "Other") || "Safari" === e || "Opera" === e) && "20030107" !== t)
            return !0;
        ...
        if (39 === t && "Internet Explorer" !== e && "Other" !== e)
            return !0;
        if (33 === t && "Chrome" !== e && "AOSP" !== e && "Opera" !== e && "Other" !== e)
            return !0;
        try {
            throw "a"
        } catch (e) {
        ...
        key: "plugins",
        getData: function(e, t) {
            D() ? t.plugins.excludeIE ? e(t.EXCLUDED) : e(u(t)) : e(o(t))
        }
    }, {
        key: "canvas",
        getData: function(e, t) {
        ...
        getData: function(e, t) {
            ...
            for (var o = 0, l = c.length; o < l; o++)
                a[c[o]] = n[o].offsetWidth,
                    i[c[o]] = n[o].offsetHeight;
            var s = function() {
                for (var e, t, n = {}, a = 0, r = u.length; a < r; a++) {
                    for (var i = [], o = 0, l = c.length; o < l; o++) {
                        var s = (e = u[a],
                            t = c[o],
                            s = void 0,
                            (s = d()).style.fontFamily = "'" + e + "'," + t,
                            s);
                        f.appendChild(s),
                            i.push(s)
                    }
            ...
            t.appendChild(f);
            for (var g = [], h = 0, m = u.length; h < m; h++)
                !function(e) {
                    for (var t = !1, n = 0; n < c.length; n++)
                        if (t = e[n].offsetWidth !== a[c[n]] || e[n].offsetHeight !== i[c[n]])
                            return t;
                    return t
                }(s[u[h]]) || g.push(u[h]);
            t.removeChild(f),
        ...
        getData: function(t, e) {
            return N() ? F() ? e.fonts.swfPath ? void G(function(e) {
                t(e)
            ...
            return null == o && (o = i,
                ...
                a.get(i, function(e) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var a = e[n];
                        a.value === (i.NOT_AVAILABLE || "not available") ? t.push({
                            key: a.key,
                            value: "unknown"
                        }) : "plugins" === a.key ? t.push({
                            key: "plugins",
                        ...
                        }) : -1 !== ["canvas", "webgl"].indexOf(a.key) && Array.isArray(a.value) ? t.push({
                            key: a.key,
                            value: a.value.join("~")
                        }) : -1 !== ["sessionStorage", "localStorage", "indexedDb", "addBehavior", "openDatabase"].indexOf(a.key) ? a.value && t.push({
                            key: a.key,
                            value: 1
                        }) : a.value ? t.push(a.value.join ? {
                            key: a.key,
                            value: a.value.join(";")
                        } : a) : t.push({
                            key: a.key,
