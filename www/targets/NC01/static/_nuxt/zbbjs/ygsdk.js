...
(function (c) {
    ...
    c.async = true;
    c.id = 'ARK_SDK';
    c.src = '/_nuxt/zbbjs/AnalysysAgent_JS_SDK.min.js' + '?v=' + time; //JS SDK存放地址
    n.parentNode.insertBefore(c, n);
})({
    appkey: 'b77d08dca61440fb', //APPKEY
    uploadURL: ENV[window.GlobalConfig.ENV], //上传数据的地址"/up"由插件自行拼接上去
    //开启全埋点
    autoTrack: true,
