...
export default {
    ...
    methods: {
        // 查看解析
        openPage(item) {
            this.$PageUtil.openNewPage(`/member/parse/SCLX/${this.classUniquecode}/${this.subjectId}/${item.questionType}?projectId=${this.projectId}`);
        },
        // 重新做题
        paperGenerate(questionType) {
            niceloo.api.call('qb/query-paper-generate', {
                ...
                onsuccess: (res) => {
                    ...
                    this.$PageUtil.href(`/member/ks/new/${this.classUniquecode}/${this.subjectId}/${paperId}?flag=SCLXKS&questionType=${questionType}`);
                },
