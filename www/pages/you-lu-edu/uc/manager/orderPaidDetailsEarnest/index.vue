            ...
            <div class="contentWrap">
                ...
                <div class="addressWrap">
                    ...
                    <div class="receiveInformation receiveInformationPay">
                        <span class="infoName">应付金额：¥{{ paidDetails.orderTotalamount | veMoneyCent }}</span>
                        <span class="infoName">优惠金额：¥{{ paidDetails.orderDiscountamount | veMoneyCent }}</span>
                        <span class="infoName">支付定金：¥{{ paidDetails.orderPayamount | veMoneyCent }}</span>
                        <span class="infoName">
                            待支付金额：
...
export default {
    ...
    computed: {
        smallWrite() {
            let m = '';
            if (this.paidDetails.moneyInfo) {
                if (this.paidDetails.moneyInfo[2]) {
                    m = this.paidDetails.moneyInfo[2].showMoney;
                } else if (this.paidDetails.moneyInfo[0]) {
                    m = this.paidDetails.moneyInfo[0].showMoney;
                }
            }
            if (m) {
