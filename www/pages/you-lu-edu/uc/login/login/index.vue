<template>
    <div class="main">
        ...
        <div class="login-wrap" v-if="isPc">
            <div class="login-container">
                <div class="login-web-content">
                    <div class="youlu-img"></div>
                    <no-ssr>
                        <div class="login-box">
                            <div id="render-login-containder"></div>
                        </div>
                    </no-ssr>
                </div>
            </div>
        ...
        <div class="phone-login-wrap" v-if="!isPc">
            <no-ssr>
...
export default {
    ...
    methods: {
        ...
        async renderLogin() {
            ...
            const params = {
                containerDomElemenet: 'render-login-containder',
                clue: { clueExtension },
        ...
        report(status = true, message = '', loginMethod) {
            ...
            // 易观上报
            this.trackLoginOrRegister(status, message, loginMethod, this.$route.query.pageName || document.title, this.$route.query.sourceType, '登录界面');
        },
        // 微信上报
        wxLoginReport() {
