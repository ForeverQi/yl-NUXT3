...
export default {
    ...
    data() {
        return {
            modelType: {
                'analysis-single': 'Radio', // 单选题
                'analysis-multiple': 'MultipleChoice', // 多选题
                'analysis-indefinite': 'MultipleChoice', // 不定项选择题
                'analysis-opinion': 'Explain', // 简答题
                'analysis-judge': 'Radio', // 判断题
                'analysis-fill': 'Fill', // 填空题
                'analysis-blank-choose': 'ChooseFill', // 选词填空
            },
        };
    },
    computed: {
    ...
    methods: {
        ...
        handleChange(type, item, questionId) {
            this.$emit('handle-change', ['case-analysis', type], item, questionId);
        },
        // 用户保存答案
        saveChange(type, item, questionId) {
            this.$emit('save-change', ['case-analysis', type], item, questionId);
        },
        // 错题本解析页单题删除
