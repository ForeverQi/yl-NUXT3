<template>
    <div class="dialog-wrap">
        <!--分配学管师-开启企业微信配置  -->
        <div class="open-WeCom" v-if="learningManager.eeUserid && learningManager.weComOConfigOpenStatus === 'Y' && learningManager.name">
            <div class="title">Hi～学员您好，</div>
            <div class="subheading">我是您的专属学管师，在接下来的学习过程中，我将全程督学陪伴您，欢迎随时联系我~</div>
            <div class="WeCom-name">
                我的企业微信：{{ learningManager.alias || learningManager.name }}
                <span>@优路教育</span>
            </div>
        ...
        <!--分配学管师-未开启企业微信配置 -->
        <div class="no-open-WeCom" v-else-if="learningManager.eeUserid && learningManager.weComOConfigOpenStatus === 'N'">
            <div class="title">Hi～学员您好，</div>
            <div class="subheading">我是您的专属学管师，在接下来的学习中，我将全程陪伴您。</div>
