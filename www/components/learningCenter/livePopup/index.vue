    ...
    <div class="tip-poup-box flex ai-center jc-center">
        <div class="tip-poup">
            <div class="title">
                ...
                <img src="./asset/images/guanbi.png" alt="" class="closed pointer" @click="closeTipPoup" />
            </div>
            ...
            <div class="cnt-box">
                ...
                <p class="flex ai-center" v-if="curTask.coursewareType == 'L' && curTask.teacher">
                    <img src="./asset/images/tip-3.png" alt="" class="mr5" />
                    主讲老师：{{ curTask.teacher }}
                </p>
