<template>
    <div class="tabWrap">
        ...
        <div class="checkAll position-right" v-show="editShow && allowShow" @click="editShow = false">
            <i class="icon edit"></i>
            <span>编辑</span>
        </div>
...
export default {
    ...
    props: {
        tabItemList: {
            ...
            default() {
                return [
                    { value: '收藏的课单', router: 'collection' },
                    { value: '购买的课单', router: 'purchased' },
                    { value: '领取的课单', router: 'receive' },
                ];
            },
        },
    },
    ...
    watch: {
        ...
        $route: {
            handler(val) {
                ...
                this.allowShow = fullPath === 'collection';
