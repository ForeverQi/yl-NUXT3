...
<script>
import sharePopup from '../../../../components/sharePopup/sharePopup/index.vue';
import haiBaoSharePopup from '../../../../components/haiBaoSharePopup/haiBaoSharePopup/index.vue';
import twicePopup from '../../../../components/twicePopup/twicePopup/index.vue';
import { mcpMineCollectionAdd, mcpMineCollectionCancel, mcpTrialWebPoster } from '../../../apis/index.js';
...
export default {
    ...
    methods: {
        ...
        mcpMineCollectionAdd() {
            return mcpMineCollectionAdd(this, { resourceId: this.experienceClass.goodsId });
        },
        mcpMineCollectionCancel() {
            return mcpMineCollectionCancel(this, { resourceId: this.experienceClass.goodsId });
        },
    },
};
</script>
