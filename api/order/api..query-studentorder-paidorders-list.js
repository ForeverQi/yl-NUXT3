...
(function() {
    var factory = function(getters) {
        ...
        var moduleName = "order", apiAlias = "query-studentorder-paidorders-list";

        var apiDefinition = {
            api: "ordering/studentorder/paidorders/get",
            method: "GET",
            apiAlias: apiAlias,
    ...
    var pluginName = "nl:order/query-studentorder-paidorders-list";
    ...
    if (typeof define === "function") {
        define([
            ...
            "./api..query-studentorder-paidorders-list.options.js"
        ], function() {
        ...
        defineModule(pluginName, [
            ...
            "nl:order/query-studentorder-paidorders-list$options=./api..query-studentorder-paidorders-list.options.js"
