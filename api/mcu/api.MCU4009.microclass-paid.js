...
(function() {
    var factory = function(getters) {
        ...
        var moduleName = "order", apiAlias = "microclass-paid";

        var apiDefinition = {
            api: "ordering/studentorder/microclass/paid/post",
            method: "POST",
            apiAlias: apiAlias,
    ...
    var pluginName = "nl:order/microclass-paid";
    ...
    if (typeof define === "function") {
        define([
            ...
            "./api.MCU4009.microclass-paid.options.js"
        ], function() {
        ...
        defineModule(pluginName, [
            ...
            "nl:order/microclass-paid$options=./api.MCU4009.microclass-paid.options.js"
