export default function () {
    !(function (e, t) {
        'object' == typeof exports && 'undefined' != typeof module
            ...
            : 'function' == typeof {} && {}.amd
            ? {}(t)
            : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).AnalysysAgent = t());
    })(this, function () {
        'use strict';
                        ...
                        (JSON.parse = function (text, reviver) {
                            ...
                            function walk(e, t) {
                                ...
                                if (r && 'object' == typeof r)
                                    for (i in r) Object.prototype.hasOwnProperty.call(r, i) && ((n = walk(r, i)) !== undefined ? (r[i] = n) : delete r[i]);
        ...
        var fieldTemplate = {
            base: { outer: ['appid', 'xwho', 'xwhat', 'xwhen', 'xcontext'], xcontext: ['$lib', '$lib_version', '$platform', '$debug', '$is_login'] },
            $startup: {
                xcontext: [
                    '$screen_width',
                    '$screen_height',
            ...
            for (var t = '', i = 0; i < e.length; i++) {
                ...
                n < 128
                    ...
                    : (127 < n && n < 2048
                          ...
                          : ((t += String.fromCharCode((n >> 12) | 224)), (t += String.fromCharCode(((n >> 6) & 63) | 128))),
        ...
        (Util.prototype.paramType = function (e) {
            ...
            (Util.prototype.toObj = function (e, t) {
                var i = {};
                return 'String' === this.paramType(e)
                    ? (i = this.keyValueToObje(e, t))
                    : 'Array' === this.paramType(e)
                    ? (i = this.ArrayToObj(e))
                    : 'Object' === this.paramType(e)
                    ? e
                    : i;
            }),
            (Util.prototype.objMerge = function (e, t) {
                ...
                for (var r in t) {
                    var o = t[r];
                    var a = i[r];
                    var s = this.paramType(o);
                    var l = this.paramType(a);
                    i[r] =
                        a && 'Object' === l && 'Object' === s
                            ? this.objMerge(a, o)
                            : 'Array' === l && 'Array' === s
                            ? this.arrayMergeUnique(a, o)
            ...
            (Util.prototype.encode = function (e) {
                ...
                var l = '';
                var c = 0;
                for (e = _utf8Encode(e); c < e.length; )
                    (r = (t = e.charCodeAt(c++)) >> 2),
                        (o = ((3 & t) << 4) | ((i = e.charCodeAt(c++)) >> 4)),
                        (a = ((15 & i) << 2) | ((n = e.charCodeAt(c++)) >> 6)),
                        (s = 63 & n),
                        isNaN(i) ? (a = s = 64) : isNaN(n) && (s = 64),
                        (l = l + _keyStr.charAt(r) + _keyStr.charAt(o) + _keyStr.charAt(a) + _keyStr.charAt(s));
                return l;
            }),
            (Util.prototype.decode = function (e) {
                ...
                for (e = e.replace(/[^A-Za-z0-9+/=]/g, ''); l < e.length; )
                    (t = (_keyStr.indexOf(e.charAt(l++)) << 2) | ((r = _keyStr.indexOf(e.charAt(l++))) >> 4)),
                        (i = ((15 & r) << 4) | ((o = _keyStr.indexOf(e.charAt(l++))) >> 2)),
                        (n = ((3 & o) << 6) | (a = _keyStr.indexOf(e.charAt(l++)))),
                ...
                for (var r in (/(y+)/.test(t) && (t = t.replace(RegExp.$1, (e.getFullYear() + '').substr(4 - RegExp.$1.length))), n))
                    new RegExp('(' + r + ')').test(t) &&
                        (t = t.replace(
                            ...
                            3 === RegExp.$1.length
                                ? ('' + n[r]).length < 3
                                    ? ('00' + n[r]).substr(('00' + n[r]).length - 3, ('00' + n[r]).length)
                                    : n[r]
            ...
            (Util.prototype.MD5 = function (e, t) {
                ...
                function c(e, t) {
                    ...
                    var r = 1073741824 & e;
                    var o = 1073741824 & t;
                    var a = (1073741823 & e) + (1073741823 & t);
                ...
                for (
                    var s,
                        ...
                        d,
                        g = (function (e) {
                            for (var t, i = e.length, n = i + 8, r = 16 * (1 + (n - (n % 64)) / 64), o = Array(r - 1), a = 0, s = 0; s < i; )
                                (a = (s % 4) * 8), (o[(t = (s - (s % 4)) / 4)] = o[t] | (e.charCodeAt(s) << a)), s++;
                    ...
                    (f = i((s = f), (u = m), (p = y), (d = h), g[b + 0], 7, 3614090360)),
                        (h = i(h, f, m, y, g[b + 1], 12, 3905402710)),
                        (y = i(y, h, f, m, g[b + 2], 17, 606105819)),
                        (m = i(m, y, h, f, g[b + 3], 22, 3250441966)),
                        (f = i(f, m, y, h, g[b + 4], 7, 4118548399)),
                        (h = i(h, f, m, y, g[b + 5], 12, 1200080426)),
                        (y = i(y, h, f, m, g[b + 6], 17, 2821735955)),
                        (m = i(m, y, h, f, g[b + 7], 22, 4249261313)),
                        (f = i(f, m, y, h, g[b + 8], 7, 1770035416)),
                        (h = i(h, f, m, y, g[b + 9], 12, 2336552879)),
                        (y = i(y, h, f, m, g[b + 10], 17, 4294925233)),
                        (m = i(m, y, h, f, g[b + 11], 22, 2304563134)),
                        (f = i(f, m, y, h, g[b + 12], 7, 1804603682)),
                        (h = i(h, f, m, y, g[b + 13], 12, 4254626195)),
                        (y = i(y, h, f, m, g[b + 14], 17, 2792965006)),
                        (f = n(f, (m = i(m, y, h, f, g[b + 15], 22, 1236535329)), y, h, g[b + 1], 5, 4129170786)),
                        (h = n(h, f, m, y, g[b + 6], 9, 3225465664)),
                        (y = n(y, h, f, m, g[b + 11], 14, 643717713)),
                        (m = n(m, y, h, f, g[b + 0], 20, 3921069994)),
                        (f = n(f, m, y, h, g[b + 5], 5, 3593408605)),
                        (h = n(h, f, m, y, g[b + 10], 9, 38016083)),
                        (y = n(y, h, f, m, g[b + 15], 14, 3634488961)),
                        (m = n(m, y, h, f, g[b + 4], 20, 3889429448)),
                        (f = n(f, m, y, h, g[b + 9], 5, 568446438)),
                        (h = n(h, f, m, y, g[b + 14], 9, 3275163606)),
                        (y = n(y, h, f, m, g[b + 3], 14, 4107603335)),
                        (m = n(m, y, h, f, g[b + 8], 20, 1163531501)),
                        (f = n(f, m, y, h, g[b + 13], 5, 2850285829)),
                        (h = n(h, f, m, y, g[b + 2], 9, 4243563512)),
                        (y = n(y, h, f, m, g[b + 7], 14, 1735328473)),
                        (f = r(f, (m = n(m, y, h, f, g[b + 12], 20, 2368359562)), y, h, g[b + 5], 4, 4294588738)),
                        (h = r(h, f, m, y, g[b + 8], 11, 2272392833)),
                        (y = r(y, h, f, m, g[b + 11], 16, 1839030562)),
                        (m = r(m, y, h, f, g[b + 14], 23, 4259657740)),
                        (f = r(f, m, y, h, g[b + 1], 4, 2763975236)),
                        (h = r(h, f, m, y, g[b + 4], 11, 1272893353)),
                        (y = r(y, h, f, m, g[b + 7], 16, 4139469664)),
                        (m = r(m, y, h, f, g[b + 10], 23, 3200236656)),
                        (f = r(f, m, y, h, g[b + 13], 4, 681279174)),
                        (h = r(h, f, m, y, g[b + 0], 11, 3936430074)),
                        (y = r(y, h, f, m, g[b + 3], 16, 3572445317)),
                        (m = r(m, y, h, f, g[b + 6], 23, 76029189)),
                        (f = r(f, m, y, h, g[b + 9], 4, 3654602809)),
                        (h = r(h, f, m, y, g[b + 12], 11, 3873151461)),
                        (y = r(y, h, f, m, g[b + 15], 16, 530742520)),
                        (f = o(f, (m = r(m, y, h, f, g[b + 2], 23, 3299628645)), y, h, g[b + 0], 6, 4096336452)),
                        (h = o(h, f, m, y, g[b + 7], 10, 1126891415)),
                        (y = o(y, h, f, m, g[b + 14], 15, 2878612391)),
                        (m = o(m, y, h, f, g[b + 5], 21, 4237533241)),
                        (f = o(f, m, y, h, g[b + 12], 6, 1700485571)),
                        (h = o(h, f, m, y, g[b + 3], 10, 2399980690)),
                        (y = o(y, h, f, m, g[b + 10], 15, 4293915773)),
                        (m = o(m, y, h, f, g[b + 1], 21, 2240044497)),
                        (f = o(f, m, y, h, g[b + 8], 6, 1873313359)),
                        (h = o(h, f, m, y, g[b + 15], 10, 4264355552)),
                        (y = o(y, h, f, m, g[b + 6], 15, 2734768916)),
                        (m = o(m, y, h, f, g[b + 13], 21, 1309151649)),
                        (f = o(f, m, y, h, g[b + 4], 6, 4149444226)),
                        (h = o(h, f, m, y, g[b + 11], 10, 3174756917)),
                        (y = o(y, h, f, m, g[b + 2], 15, 718787259)),
                        (m = o(m, y, h, f, g[b + 9], 21, 3951481745)),
                        (f = c(f, s)),
                        (m = c(m, u)),
                        (y = c(y, p)),
                        (h = c(h, d));
            ...
            (Util.prototype.delEmpty = function (e) {
                ...
                for (var i in e) {
                    var n = !0;
                    var r = this.paramType(e[i]);
                    'Object' !== r
                        ? (e[i] || ('Number' === r && !isNaN(e[i])) || 'Boolean' === r || (n = !1), !0 === n && (t[i] = e[i]))
                        : (t[i] = this.delEmpty(e[i]));
                }
                for (var o in t) {
                    var a = [];
            ...
            (Util.prototype.addEvent = function (e, t, i, n) {
                if (document.addEventListener)
                    if (('Array' !== this.paramType(e) && 'HTMLCollection' !== this.paramType(e)) || !e.length || e === window) e.addEventListener(t, i, n);
            ...
            (Util.prototype.removeEvent = function (e, t, i, n) {
                if (document.removeEventListener)
                    if (e.length) for (var r = 0; r < e.length; r++) this.removeEvent(e[r], t, i, n);
            ...
            (Util.prototype.addEleLable = function (e, t, i, n) {
                ...
                var a = n || r.body || r.getElementsByTagName('body')[0];
            ...
            (Util.prototype.addScript = function (e, t, i) {
                ...
                if (t) {
                    ...
                    for (var s = 0; s < o.length; s++)
                        if (o[s].src && -1 < o[s].src.indexOf('AnalysysAgent_JS_SDK')) {
                            a = o[s].src;
                            break;
                        }
                var l = a.substring(0, a.lastIndexOf('/') + 1);
                (r.src = l + e + '.min.js?v=' + this.format(new Date(), 'yyyyMMddhhmm')),
                    (r.onload = setTimeout(i, 500)),
                    o[0].parentNode.insertBefore(r, o[0]);
            }),
                    ...
                    for (var s = 0; s < o.length; s++)
                        if (null != (r = o[s].split('=')) && r[0] === e) {
                            ...
                            if ((-1 < r[1].indexOf('#') && (l = l.split('#')[0]), -1 < l.indexOf('%'))) {
                                ...
                                if ('Object' === this.paramType(window.AnalysysModule) && 'Function' === this.paramType(window.AnalysysModule.decodeGBK))
                                    try {
            ...
            (Util.prototype.changeHash = function (e) {
                ...
                var n;
                'on' + (n = window.ActiveXObject || 'ActiveXObject' in window ? 'hashchange' : 'popstate') in window &&
                    this.addEvent(window, n, function () {
                        setTimeout(e, 0);
                    });
            }),
            (Util.prototype.deviceType = function () {
                var e = navigator.userAgent;
                return (-1 < e.indexOf('Tablet') && e.indexOf('PC') < 0) || -1 < e.indexOf('Pad') || -1 < e.indexOf('Nexus 7')
                    ? 'tablet'
                    : -1 < e.indexOf('Mobi') || -1 < e.indexOf('iPh') || -1 < e.indexOf('480')
                    ? 'phone'
                    : 'desktop';
            }),
            (Util.prototype.checkTypeList = function (e, t) {
                ...
                if ('String' === i) {
                    ...
                    var o = r + window.location.pathname;
            ...
            (Util.prototype.selectorAllEleList = function (e) {
                var t = [];
                var i = e.split('.')[0];
                if ('Function' === this.paramType(document.querySelectorAll) && e.indexOf('|') < 0)
                    try {
                ...
                if (-1 < e.indexOf('#')) {
                    ...
                    if (-1 < e.indexOf('[') && -1 < e.indexOf(']'))
                        for (var o = document.getElementsByTagName('*'), a = e.replace('[', '').replace(']', ''), s = 0; s < o.length; s++) {
                            var l = o[s].getAttribute(a);
                            'String' === this.paramType(l) && t.push(r);
                        }
                    else
                        for (var c = document.getElementsByTagName(i), u = 0; u < c.length; u++) {
                            var p = c[u];
                            var d = 'String' === this.paramType(p.className) ? p.className.split(' ') : [];
            ...
            (Util.prototype.delNotHybrid = function (e) {
            ...
            (Util.prototype.detectZoom = function () {
                for (var e = this.selectorAllEleList('meta'), t = 1, i = 0; i < e.length; i++) {
                    ...
                    if (n && -1 < n.indexOf('initial-scale='))
                        for (var r = n.split(','), o = 0; o < r.length; o++) -1 < r[o].indexOf('initial-scale') && (t = parseFloat(r[o].split('=')[1]));
                }
                return t;
            });
        var Util$1 = new Util();
        ...
        var Session = '';
        try {
            (Local = 'object' == typeof window.localStorage ? window.localStorage : ''),
                (Session = 'object' == typeof window.sessionStorage ? window.sessionStorage : '');
        } catch (e) {}
        function Storage() {
            (this.localName = 'FZ_STROAGE'),
                (this.sessionName = 'FZ_SESSION'),
                (this.cookieName = 'FZ_STROAGE.' + Util$1.getDomainFromUrl(baseConfig.base.cross_subdomain)),
                this.checkSubdomain(),
        ...
        (Storage.prototype.checkSubdomain = function () {
            ...
            var i;
            var n;
            var r = window.AnalysysAgent || [];
            if ('Array' === Util$1.paramType(r))
                for (var o = 0; o < r.length; o++)
                    'cross_subdomain' === r[o][0] && 'Boolean' === Util$1.paramType(r[o][1]) && (baseConfig.base.cross_subdomain = r[o][1]);
            r && Util$1.objHasKay(r.config || {}, 'cross_subdomain') && (baseConfig.base.cross_subdomain = r.config.cross_subdomain),
                !0 === baseConfig.base.cross_subdomain &&
                    ((n = this.getCookie(this.cookieName) || Util$1.encode('{}')),
                    (n = JSON.parse(Util$1.decode(decodeURIComponent(n)))),
                    'Object' !== Util$1.paramType(n) ||
                        Util$1.isEmptyObject(n) ||
                        ((e = n.ARK_ID),
                        (t = {}),
                        !0 === Util$1.objHasKay(n, 'ARKSUPER') && ((t = n.ARKSUPER), delete n.ARKSUPER),
                        (i = Util$1.objMerge(this.localObj || {}, n)),
                        !0 !== baseConfig.base.cross_subdomain_super || Util$1.isEmptyObject(t) || (i = Util$1.objMerge({ ARKSUPER: t }, i)),
                        this.setLocal(this.localName, i),
                        this.setCookie('ARK_ID', e)));
        }),
            (Storage.prototype.setLocal = function (t, i) {
                ...
                try {
                    ...
                    Local
                        ...
                        : 'POSTDATA' !== t && this.setCookie(this.cookieName, encodeURIComponent(Util$1.encode(JSON.stringify(this.localObj)))),
                        'POSTDATA' !== t &&
                            !0 === baseConfig.base.cross_subdomain &&
                            (delete (n = Util$1.toDeep(this.localObj)).POSTDATA,
                            this.setCookie(this.cookieName, encodeURIComponent(Util$1.encode(JSON.stringify(n)))));
                } catch (e) {}
            }),
            (Storage.prototype.getLocal = function (t) {
                try {
                    ...
                    return (
                        Local
                            ? (i = Local.getItem(this.localName)) ||
                              (Session.getItem(this.localName) && ((i = Session.getItem(this.localName)), Local.setItem(this.localName, i)))
                            : (i = (i = this.getCookie(this.cookieName)) ? decodeURIComponent(i) : Util$1.encode(JSON.stringify(this.localObj))),
                        (this.localObj = JSON.parse(Util$1.decode(i))),
                        t ? this.localObj[t] : this.localObj
                    );
                } catch (e) {
                    return t ? '' : {};
                }
            ...
            (Storage.prototype.removeLocal = function (t) {
                var i;
                if (((this.localObj = this.getLocal()), Util$1.objHasKay(this.localObj, t) && delete this.localObj[t], Util$1.isEmptyObject(this.localObj)))
                    try {
                    ...
                    Local &&
                        ...
                        'POSTDATA' !== t &&
                            'ARK_ID' !== t &&
                            !0 === baseConfig.base.cross_subdomain &&
                            (delete (i = Util$1.toDeep(this.localObj)).POSTDATA,
                            delete i.ARK_ID,
                            this.setCookie(this.cookieName, Util$1.encode(JSON.stringify(i))));
            }),
            (Storage.prototype.setSession = function (t, i) {
                (this.sessionObj = this.getSession()), (this.sessionObj[t] = i);
                try {
                    Session
                        ? (Session.setItem(this.sessionName, Util$1.encode(JSON.stringify(this.sessionObj))), this.removeCookie(this.sessionName))
                        : 'POSTDATA' !== t && this.setCookie(this.sessionName, Util$1.encode(JSON.stringify(this.sessionObj)), 'session');
                } catch (e) {}
            }),
            (Storage.prototype.getSession = function (t) {
                try {
                    ...
                    return (
                        Session
                            ? ((i = Session.getItem(this.sessionName) || Util$1.encode('{}')), this.removeCookie(this.sessionName))
                            : (i = (i = this.getCookie(this.sessionName)) || Util$1.encode(JSON.stringify(this.sessionObj))),
                        (this.sessionObj = JSON.parse(Util$1.decode(i))),
                        t ? this.sessionObj[t] : this.sessionObj
                    );
                } catch (e) {
                    return {};
                }
            ...
            (Storage.prototype.removeSession = function (t) {
                if (
                    ((this.sessionObj = this.getSession()),
                    Util$1.objHasKay(this.sessionObj, t) && delete this.sessionObj[t],
                    Util$1.isEmptyObject(this.sessionObj))
                )
                    try {
            ...
            (Storage.prototype.setCookie = function (e, t, i) {
                var n;
                var r = '.' + Util$1.getDomainFromUrl(baseConfig.base.cross_subdomain);
                var o = r ? '; domain=' + r : '';
                var a = '';
                'session' !== i && ((n = new Date()).setTime(n.getTime() + 31536e6), (a = '; expires=' + n.toGMTString())),
            ...
            (Storage.prototype.removeCookie = function (e, t, i) {
                ...
                var n;
                var r;
                var o = '.' + Util$1.getDomainFromUrl(t);
                var a = o ? '; domain=' + o : '';
                'session' !== i && ((n = new Date()).setTime(n.getTime() - 94608e6), (r = '; expires=' + n.toGMTString())),
                    (document.cookie = e + '=' + r + '; path=/' + a);
            });
        ...
        (SessionId.prototype.setId = function () {
            var e = +new Date();
            return (
                (this.sessionId = Util$1.MD5('JS' + e.toString() + 1e7 * Math.random())),
                (this.sessionDate = e),
            ...
            (SessionId.prototype.getId = function () {
                ...
                var t = e.getTime();
                var i = e.getTimezoneOffset();
                var n = new Date(t + 60 * i * 1e3 + 288e5).getDate();
                ...
                return (
                    (this.sessionId && this.sessionDate && !(18e5 < Number(t) - Number(this.sessionDate)) && n === r) || (clearUTM(), this.setId()),
                    (this.sessionDate = t),
                    Storage$1.setLocal('SEESIONDATE', t),
        ...
        function getId() {
            ...
            return (
                (e && '[object Object]' !== e) || ((e = setUUId()), Storage$1.setLocal('ARK_ID', e)),
        ...
        function setUUId() {
            ...
            var t = 'JS' + Util$1.MD5(e.toString(), 32) + Util$1.MD5(e.toString(), 32).slice(0, 4);
        ...
        function isFirstDay() {
            ...
            var t = Storage$1.getLocal('FRISTDAY');
            return !t || e === t;
        }
        function originalId() {
        ...
        function getReferrer() {
            ...
            return !0 === baseConfig.base.isHybrid && (t = encodeURIComponent(t)), t;
        }
        ...
        UTM.utm_campaign || UTM.utm_source || UTM.utm_medium || UTM.utm_campaign_id || UTM.utm_term || UTM.utm_content
            ? (oldUTM !== JSON.stringify(UTM) && sessionId.setId(), Storage$1.setSession('ARK_UTM', JSON.stringify(UTM)))
            : (clearUTM(), Storage$1.removeSession('ARK_UTM'));
        var getField = {
            __proto__: null,
            getAppId,
            getId,
        ...
        var fieldRules = {
            ...
            appid: { valueType: 0, value: getAppId, check: { value: ['isString', 'nimLength'], errorCode: '60006', successCode: '20006' } },
            ...
            xcontextCommonRule: {
                check: { key: ['isString', 'length99', 'notSpecialCharacters', 'keywords'], value: ['notObject', 'isArrayString', 'length255'] },
            },
        ...
        var lifecycle = {};
        var fieldRules$1 = { 'visitorConfigURL ': { check: { value: ['isUrl'] } } };
        var fieldTemplate$1 = {};
        function getElementContent(e, t) {
            ...
            if (
                ('input' === e.tagName.toLowerCase()
                    ...
                    ? (i = e.getAttribute('alt') || e.getAttribute('title') || '')
                    : 'a' === e.tagName.toLowerCase() && (i = e.getAttribute('title') || ''),
                !i)
            )
                for (var n = e.childNodes, r = 0; r < n.length; r++) 3 === n[r].nodeType && (i += n[r].nodeValue);
            return (
                (i = i && 'String' === Util$1.paramType(i) ? i.replace(/[\r\n]/g, ' ').replace(/[ ]+/g, ' ') : ''),
                'input' === e.tagName.toLowerCase() && 'button' !== e.type && 'submit' !== e.type && !0 !== t ? '' : (i = Util$1.trim(i))
            );
        }
        var androidModel = {
            hashCode: '',
        ...
        function getDomList(e, t, i) {
            ...
            for (-1 < ['a', 'button', 'input', 'select', 'textarea'].indexOf(s) && (l = !1); null !== r; ) {
                ...
                if (0 < c.length)
                    for (var u = 0; u < c.length; u++)
                        if (
                            (id++,
                            1 === c[u].nodeType && c[u].tagName && ['canvas', 'svg', 'use', 'script', 'meta', 'style'].indexOf(c[u].tagName.toLowerCase()) < 0)
                        )
                            if ('TABLE' === c[u].tagName)
                                for (var p = c[u].children, d = 0; d < p.length; d++) {
                                    id++;
                                    var g = getDomList(p[d], n, l);
                                    var f = getConstantStyle(p[d], 'position');
                                    g && ('absolute' === f ? a.push(g) : o.push(g));
                                }
                            else {
                                var m = getDomList(c[u], n, l);
                                var y = getConstantStyle(c[u], 'position');
            ...
            var h = {};
            return (
                ((h = (!0 === Util$1.isiOS ? setiOSModel : setAndroidModel)(e, n, t, o, i)).url = Util$1.getUrlPath()),
                (h.root_id = 'web' + rootId),
                'TABLE' !== e.tagName && eleList.push(h),
                n
            );
        }
        ...
        function setiOSModel(e, t, i, n, r) {
            ...
            var a = eleOffset(e);
            (o.id = t),
                (o.properties.frame.values[0].value.Width = (e.offsetWidth || e.scrollWidth || e.clientWidth) * detect),
                (o.properties.frame.values[0].value.Height = (e.offsetHeight || e.offsetHeight || e.clientHeight) * detect),
                (o.properties.frame.values[0].value.AX = a.left * detect),
                (o.properties.frame.values[0].value.AY = a.top * detect);
            var s = domParentList(e);
            (o.new_path = s.newPath),
                (o.class = e.className && 'String' === Util$1.paramType(e.className) ? e.className.split(' ') : []),
                (o.eg_text = getElementContent(e)),
                (o.properties.enabled.values[0].value = !0),
                (o.properties.subviews.values[0].value = n),
                (o.properties.superview.values[0].value = i),
                (o.bodyWidth = (window.innerWidth || document.body.offsetWidth || document.body.scrollWidth || document.body.clientWidth) * detect),
                (o.bodyHeight = (window.innerHeight || document.body.offsetHeight || document.body.scrollHeight || document.body.clientHeight) * detect),
                (o.bodyScrollTop = a.bodyScrollTop * detect),
                (o.bodyScrollLeft = a.bodyScrollLeft * detect),
                (o.eleScrollTop = a.eleScrollTop * detect),
                (o.eleScrollLeft = a.eleScrollLeft * detect);
            var l = ('' !== e.style.filter ? e.style.filter.match(/opacity:[/S/s]*?\)/)[0] : e.style.opacity) || 1;
            return (
                (o.properties.alpha.values[0].value = l),
                !1 === r && ((o.properties.userInteractionEnabled.values[0].value = !1), (o.properties.enabled.values[0].value = !1)),
                o
            );
        }
        function setAndroidModel(e, t, i, n, r) {
            ...
            return (
                ...
                (o.width = (e.offsetWidth || e.scrollWidth || e.clientWidth) * detect),
                (o.height = (e.offsetHeight || e.scrollHeight || e.clientHeight) * detect),
                (o.aleft = (a.left - a.eleScrollLeft) * detect),
                (o.atop = (a.top - a.eleScrollTop) * detect),
                (o.bodyScrollTop = 0),
                (o.bodyScrollLeft = 0),
                (o.eleScrollTop = a.eleScrollTop * detect),
                (o.eleScrollLeft = a.eleScrollLeft * detect),
                (o.clickable = !1 !== r),
                (o.text = getElementContent(e)),
                (o.alpha = ('' !== e.style.filter ? e.style.filter.match(/opacity:[/S/s]*?\)/)[0] : e.style.opacity) || 1),
                (o.classes = e.className && 'String' === Util$1.paramType(e.className) ? e.className.split(' ') : []),
                (o.subviews = n),
                o
            );
        }
        ...
        var HybridAns = {
            ...
            onEventList(e) {
                ...
                for (var t = [], i = 0; i < e.length; i++)
                    (1 !== e[i].isAll && e[i].target_page && e[i].target_page !== Util$1.getUrlPath()) || ((e[i].bindings = e[i].props_binding), t.push(e[i]));
                HybridAns.visitorEventList = t;
            },
            getProperty(e) {
        ...
        function getPath(e) {
            for (
                var t = e.tagName.toLowerCase(), i = '', n = 'String' !== Util$1.paramType(e.className) ? [] : e.className.split(' '), r = 0;
                r < n.length;
                r++
            )
                n[r] && n[r].indexOf('ARK') < 0 && (i += '.' + n[r]);
        ...
        function domParentList(e, t) {
            for (var i, n, r, o = [], a = [], s = e; null != s; ) {
                1 === s.nodeType
                    ? ((i = getPath(s)),
                      !(n = null) !== t && (n = getEleIndex(s)),
                      o.push(i.tagName + (i.id ? '#' + i.id : '') + i.className),
                      (r = { id: i.id, tagName: i.tagName }),
                      null !== i.row ? (r.row = n.row) : (r.index = n.index),
                      a.push(Util$1.delEmpty(r)),
                      (s = s.parentNode))
                    : (s = s.parentNode);
            }
        ...
        function getEleIndex(e) {
            for (var t = e.parentNode, i = 0, n = !0, r = null; null !== t && !0 === n; ) {
                if (1 === t.nodeType) {
                    ...
                    for (var u = 0; u < o.length; u++) !0 === newPathContrast({ newPath: a[u] }, s) && (r = i);
                    n = !1;
                } else t = t.parentNode;
            }
        ...
        function newPathContrast(e, t, i) {
            var n = e.newPath;
            var r = Util$1.arrayMerge([], n);
            var o = Util$1.arrayMerge([], t);
            var a = Util$1.arrayMerge([], n);
            if (r === o) return !0;
            if (r.length < o.length) return !1;
            if (e.ele && r.length > o.length) {
                if (!0 === i) return !1;
                var s = r.length - o.length;
                r.splice(0, s);
                for (var l = e.ele, c = 0; c < s; c++) l = l.parentNode || document.body;
                (e.ele = l), (a = Util$1.arrayMerge([], r));
            }
            for (var u = !0, p = 0; p < o.length; ) {
                var d = o[p];
                var g = r[p];
                if (
                    (!0 === Util$1.objHasKay(g, 'row') && !1 === Util$1.objHasKay(d, 'row') && !1 === Util$1.objHasKay(g, 'index') && delete g.row,
                    (d.id && d.id !== g.id) || d.tagName !== g.tagName || g.index !== d.index || g.row !== d.row)
                ) {
                    u = !1;
                    break;
                }
            ...
            return !0 === u && (e.newPath = a), u;
        }
        function isClassContrast(e, t) {
            var i = e ? e.className : null;
            return !!(
                'String' === Util$1.paramType(i) &&
                'String' === Util$1.paramType(t) &&
                ((i = Util$1.trim(i) || null), (t = Util$1.trim(t) || null), i && t && -1 < i.indexOf(t))
            );
        }
        ...
        function pathContrast(e, t, i) {
            ...
            var r = !1;
            if (
                ((t.bindings = t.bindings || t.props_binding),
                e.newPath && t.newPath && ((r = !0), (n = newPathContrast(e, t.newPath, i))),
                !0 === n && t.bindings && 0 < t.bindings.length && ((r = !0), (n = bindingContrast(e.ele, t.bindings))),
                r)
            )
                return n;
            var o = e.path || e.link;
        ...
        function parseNewPath(e) {
            for (
                var t = e[0], i = t.id, n = t.className || '', r = t.tagName, o = i ? '#' + i : r + n, a = Util$1.selectorAllEleList(o), s = 0, l = [];
                s < a.length;

            ) {
                var c = a[s];
                var u = domParentList(c);
                !0 === checkNewPathBase(u.newPath, e) && !0 === newPathContrast(u, e) && l.push(c), s++;
            }
            return l;
        }
        ...
        function eleOffset(t) {
            for (
                var i = 0, n = 0, r = getEleScroll(t), o = r.scrollTop, a = r.scrollLeft, s = !1;
                t && t.tagName && ['canvas', 'svg', 'use', 'script', 'meta', 'style'].indexOf(t.tagName.toLowerCase()) < 0;
            ...
            return (
                !0 === s &&
                    ((i += o),
                    (n += a),
                    (i += document.body.scrollTop || document.documentElement.scrollTop || 0),
                    (n += document.body.scrollLeft || document.documentElement.scrollLeft || 0)),
                {
                    top: i,
                    left: n,
                    hidden: !1,
        ...
        function backH5PathProPath(e, t) {
            var i = Util$1.arrayMerge([], e);
            var n = Util$1.arrayMerge([], t.h5_path);
            var r = t.step;
            0 !== r && i.splice(0, r), n.splice(n.length - 1, 1);
            for (var o = 0; o < i.length; o++) n.push(i[o]);
            return n;
        }
        function getRelated(e, t, i) {
            if (!e) return {};
            'Object' === Util$1.paramType(e) && (e = [e]);
            for (var n, r = {}, o = [], a = {}, s = 0; s < e.length; s++) {
                var l;
                var c;
                var u;
                var p = e[s];
                var d = p.target.h5_path;
                d
                    ? ((c = (l = parseNewPath(d)[0]) ? getElementContent(l, !0) : ''), (u = getProperties(p.properties, c)), (r = Util$1.objMerge(r, u)))
                    : o.push(p);
            }
            if (0 < o.length) {
                if (!1 !== Util$1.isiOS)
                    return (
                        (HybridAns.visitorProperties[i] =
                            ((n = r),
                            function (e) {
                                (n = Util$1.objMerge(n, e)), t(n);
                            })),
                        void (!0 === window.AnalysysModule.moduleStatus
                            ? window.AnalysysModule.getPro(o, i)
                            : window.webkit.messageHandlers.AnalysysAgentGetProperty.postMessage([JSON.stringify(o), i]))
                    );
                (a = window.AnalysysAgentHybrid.getProperty(JSON.stringify(o))),
                    'String' === Util$1.paramType(a) && (a = JSON.parse(a)),
                    (r = Util$1.objMerge(r, a));
            } else !0 === Util$1.isiOS && !0 === baseConfig.base.isHybrid && t && t(r);
            return r;
        }
        function getProperties(t, i) {
            for (var n = {}, r = 0; r < t.length; r++) {
                ...
                else if ('bool' === a) 'Boolean' !== Util$1.paramType(i) && ('true' === i || '1' === i ? (i = !0) : ('false' !== i && '0' !== i) || (i = !1));
                else
                    try {
                        i = i.toString();
                    } catch (e) {}
        ...
        function xmlhttp(t) {
                ...
                (a.onreadystatechange =
                    ...
                    function () {
                        if (4 === n.readyState) {
                            try {
                                var t, i;
                                (-1 < n.getAllResponseHeaders().indexOf('Date') || -1 < n.getAllResponseHeaders().indexOf('date')) &&
                                    ((t = +new Date()),
                                    (i = n.getResponseHeader('Date') || n.getResponseHeader('date')) && !0 === baseConfig.base.allowTimeCheck
                                        ? Storage$1.setLocal('ANSSERVERTIME', new Date(i) - t)
                                        : Storage$1.setLocal('ANSSERVERTIME', 0));
                            } catch (e) {}
            ...
            try {
                ...
                'GET' === t.type ? ((s = baseConfig.base.getDataTimeout), a.send(null)) : a.send(t.data),
                    'Number' === Util$1.paramType(s) &&
                        ('Number' === Util$1.paramType(a.timeout)
                            ? (a.timeout = s)
                            : ((i = a),
                              setTimeout(function () {
                                  i.abort();
        ...
        function successLog(e) {
            var t, i, n, r, o, a, s;
            (1 !== baseConfig.base.$debug && 2 !== baseConfig.base.$debug) ||
                ((i = (t = baseConfig.status).successCode),
                (n = t.FnName),
                (r = t.key),
                (o = t.value),
                (a = successMessage[i] || successMessage.common),
                'String' === Util$1.paramType(r) && 30 < r.length && (r = Util$1.stringSlice(r, 30) + '...'),
                'String' === Util$1.paramType(n) && 30 < n.length && (n = Util$1.stringSlice(n, 30) + '...'),
                (s = a.replace('{FN}', n).replace('{KEY}', r).replace('{VALUE}', o)),
                e && (s = e),
                s && window.console && window.console.log && window.console.log(s));
        }
        function errorLog() {
            var e, t, i, n, r, o, a, s;
            (1 !== baseConfig.base.$debug && 2 !== baseConfig.base.$debug) ||
                ((t = (e = baseConfig.status).errorCode),
                (i = e.FnName),
                (n = e.key),
                (r = e.value),
                'Object' === Util$1.paramType(r) && (r = JSON.stringify(r)),
                (o = Util$1.paramType(r)),
                '600018' !== t || n || (t = '600011'),
                '60005' !== t || n || (t = '600017'),
                ('600017' === t || '600019' === t || '60009' === t || '600010' === t || '60005' === t) &&
                    'String' === Util$1.paramType(r) &&
                    r.length &&
                    30 < r.length &&
                    (r = Util$1.stringSlice(r, 30) + '...'),
                'String' === Util$1.paramType(n) && 30 < n.length && (n = Util$1.stringSlice(n, 30) + '...'),
                'String' === Util$1.paramType(i) && 30 < i.length && (i = Util$1.stringSlice(i, 30) + '...'),
                (a = (errorMessage[t] || errorMessage.common).replace('{FN}', i).replace('{KEY}', n).replace('{VALUE}', r).replace('{VALUETYPE}', o)),
                window.console && window.console.warn && window.console.warn(a),
                lifecycle$5.errorLog &&
                    lifecycle$5.errorLog.init &&
                    '60008' !== t &&
                    ((s = baseConfig.status.FnName), lifecycle$5.errorLog.init(a), (baseConfig.status.FnName = s)));
        }
        var visitorConfig = {};
        var patt = /\d{13}/g;
        var clickEleObj = { path: '', index: 0, ele: null, newPath: {}, elePostion: {} };
        function loadVisitorSDK() {
            ...
            Util$1.addScript('AnalysysAgent_JS_SDK_VISUAL', visitorConfig.SDKFileDirectory, n),
                (window.ARK_VISUAL = { config: visitorConfig }),
                Storage$1.setSession('visitor', !0),
                getMsg(i);
        }
        ...
        function addElesListener() {
            ...
            for (var i = 0; i < visitorEventList.length; i++) {
                var n = Util$1.toDeep(visitorEventList[i]);
                var r = n.path;
                var o = n.index;
                var a = n.new_path;
                var s = n.bindings;
                var l = n.elePath;
                var c = n.eleClass;
                var u = clickEleObj.ele;
                var p = !1;
                var d = n.appEventId || n.event_id;
                var g = n.isText;
                var f = { path: r, index: o, newPath: a, bindings: s, isText: g };
                if ((a || s) && 1 == checkNewPathBase(clickEleObj.newPath, a)) {
                    if (!0 === pathContrast(clickEleObj, f)) {
                        var m = 'Track' + +new Date();
                        var y = (function (t, i, n) {
                            return function (e) {
                                (e = e || {}),
                                    i && 0 < i.length && (e = Util$1.objMerge(e, getProperties(i))),
                                    (e = Util$1.delEmpty(e)),
                                    !0 === visitorConfig.isHybrid
                                        ? !0 === Util$1.isiOS && !0 === window.AnalysysModule.moduleStatus
                                            ? window.AnalysysModule.track(t, e, n)
                                            : !0 === Util$1.isiOS
                                            ? (window.webkit.messageHandlers.AnalysysAgentTrack.postMessage([t, JSON.stringify(e), JSON.stringify(n)]),
                                              console.log('触发的埋点发送到ios', [t, JSON.stringify(e), JSON.stringify(n)]))
                                            : (window.AnalysysAgentHybrid.AnalysysAgentTrack(t, JSON.stringify(e), JSON.stringify(n)),
                                              console.log('触发的埋点发送到android', [t, JSON.stringify(e), JSON.stringify(n)]))
                                        : window.AnalysysAgent.track(t, e);
                            };
                        })(d, n.properties, clickEleObj.elePostion);
                        if (n.related && 0 < n.related.length)
                            for (var h = 0; h < n.related.length; h++) {
                                var b = n.related[h].target;
                                b.h5_path && ((b.path = b.h5_path), (n.related[h].target.h5_path = backH5PathProPath(clickEleObj.newPath, b)));
                            }
                        else n.related = [];
                        if (!0 === Util$1.isiOS && !0 === visitorConfig.isHybrid) return void getRelated(n.related, y, m);
                        y(getRelated(n.related));
                    }
                } else
                    a ||
                        s ||
                        !clickEleObj.ele ||
                        !0 !== checkPointBase(clickEleObj.elePath, l) ||
                        ((clickEleObj.index = setIndex(clickEleObj.ele, clickEleObj.path)),
                        ((c === clickEleObj.eleClass && o === clickEleObj.index) || !0 === pathContrast(clickEleObj, f)) && (p = !0),
                        !0 === p && ((g && g !== getElementContent(u)) || window.AnalysysAgent.track(d)));
            }
        }
        ...
        function getVisitorEvent() {
            var e, t, i;
            !0 === visitorConfig.isHybrid
                ? !0 === window.AnalysysModule.moduleStatus
                    ? window.AnalysysModule.eventList()
                    : !0 === Util$1.isiOS && window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.AnalysysAgentGetEventList
                    ? window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.AnalysysAgentGetEventList.postMessage([])
                    : !window.AnalysysAgentHybrid || ((e = window.AnalysysAgentHybrid.getEventList()) && HybridAns.onEventList(e))
                : visitorConfig.visitorConfigURL &&
                  ((t = window.location.hash) && -1 < t.indexOf('?') && (t = t.split('?')[0]),
        ...
        function getPoint(e) {
            ...
            var t = function (e) {
                if (0 === e.code) {
                    for (var t = visitorEventList, i = [], n = 0; n < e.data.length; n++) {
                        var r = e.data[n];
                        var o = parsePath(r.link);
                        var a = r.index;
                        var s = o.clickClass;
                        var l = o.clickPath;
                        var c = r.isText;
                        var u = r.link;
                        !0 === patt.test(u) && (u = u.replace(patt, '')),
                            t.push({
                                index: a,
                                eleClass: s,
                                elePath: l,
            ...
            var i = { url: d, data: { appkey: visitorConfig.appid, lib: 'Js', url: e }, success: t, error() {} };
            new ajax().get(i);
        }
        var url = window.location.href;
        var detect$1 = Util$1.detectZoom();
        function pcMouseOver(e) {
            var t = !1;
            e.touches && 0 < e.touches.length && ((e = e.touches[0]), (t = !0));
            for (
                var i = e.target || e.srcElement, n = 'String' !== Util$1.paramType(i.className) ? [] : i.className.split(' '), r = '', o = 0;
                o < n.length;
                o++
            )
                n[o] && n[o].indexOf('ARK') < 0 && (r += '.' + n[o]);
            ((clickEleObj = { ele: i, eleClass: r, index: 0 }).elePostion = {
                ...
                t ? addElesListener() : Util$1.addEvent(i, 'mousedown', addElesListener);
        }
        function pcMouseOut(e) {
            var t = (e = e || window.event).target || e.srcElement;
            (clickEleObj = {}), Util$1.removeEvent(t, 'mousedown', addElesListener);
        }
        function addEventListener() {
            'desktop' === Util$1.deviceType() && !1 === visitorConfig.isHybrid
                ? (Util$1.addEvent(document, 'mouseover', pcMouseOver, !0), Util$1.addEvent(document, 'mouseout', pcMouseOut))
                : Util$1.addEvent(document, 'touchstart', pcMouseOver, !0),
        ...
        function visitorInit(e) {
            return (
                ((visitorConfig = e).visitorConfigURL = Util$1.trim(visitorConfig.visitorConfigURL)),
                !1 === e.isHybrid &&
                (Util$1.GetUrlParam('visual') || (!0 === Storage$1.getSession('visitor') && window.location.href.indexOf('arkheatmap=true') < 0))
                    ? loadVisitorSDK()
                    : (!visitorConfig.visitorConfigURL && !0 !== e.isHybrid) ||
                      (visitorConfig.visitorConfigURL &&
                          '/' !== visitorConfig.visitorConfigURL.charAt(visitorConfig.visitorConfigURL.length - 1) &&
                          (visitorConfig.visitorConfigURL += '/'),
                      getVisitorEvent(),
                      addEventListener()),
                e
        ...
        var visitor = { __proto__: null, fieldRules: fieldRules$1, fieldTemplate: fieldTemplate$1, lifecycle: lifecycle$1 };
        ...
        var elePostion = { ele: '', click_x: 0, click_y: 0, clickEle: '' };
        var Gm;
        var Hm;
        var Im;
        var Jm;
        function domParentList$1(e) {
            for (var t = [], i = e; null != i; ) {
                ...
                if (a) {
                    a = a.toLowerCase();
                    var s = i.id ? '#' + i.id : '';
                    var l = i.className && 'String' === Util$1.paramType(i.className) ? i.className.split(' ') : [];
                    if (0 < l.length) {
        ...
        function checkElementConfig(e) {
            ...
            if ('String' === Util$1.paramType(e)) {
                ...
                var n = 'String' === Util$1.paramType(t.className) ? '.' + t.className.split(' ').join('.') : '';
                var r = t.id ? '#' + t.id : '';
        ...
        function getParentClickableElement() {
            for (var e = elePostion.ele; null != elePostion.ele; )
                if (1 === elePostion.ele.nodeType) {
        ...
        function getElementClickable() {
            ...
            if (
                -1 < ['a', 'button', 'input', 'select', 'textarea', 'svg'].indexOf(e) ||
                getElementAttrClick() ||
                checkElementConfig(baseConfig.base.trackList)
            ) {
                if ('svg' === e && elePostion.ele.children && 0 < elePostion.ele.children.length) {
                    for (var t = 0, i = elePostion.ele.children, n = 0; n < i.length; n++)
                        'use' === i[n].tagName.toLowerCase() &&
                            (i[n].getAttribute('xlink:href') || getElementAttrClick() || checkElementConfig(baseConfig.base.trackList)) &&
                            (t = 1);
                    return t;
                }
                return 1;
        ...
        function Km(e) {
            (this.time = e.time),
                ...
                (this.rootBounds = Tm(e.rootBounds)),
                (this.boundingClientRect = Tm(e.boundingClientRect)),
                (this.intersectionRect = Tm(e.intersectionRect || Sm())),
        ...
        function Rm(e) {
            ...
            return t
                ? ((t.width && t.height) ||
                      (t = { top: t.top, right: t.right, bottom: t.bottom, left: t.left, width: t.right - t.left, height: t.bottom - t.top }),
                  t)
                : Sm();
        }
        function Sm() {
        ...
        function Wm(e) {
            var t = e.parentNode;
            return 9 == e.nodeType && e != Gm ? Fm(e) : t && 11 == t.nodeType && t.host ? t.host : t && t.assignedSlot ? t.assignedSlot.parentNode : t;
        }
        function eleCss(e, t) {
            var i, n, r, o;
            if (e) {
        ...
        function eleOffset$1(e) {
            for (var t = 0, i = 0, n = !1, r = !1; null != e; )
                (t += e.offsetTop),
                    (i += e.offsetLeft),
                    (n = n || !('none' !== eleCss(e, 'display') && '0px' !== eleCss(e, 'width') && '0px' !== eleCss(e, 'height'))),
                    'fixed' === eleCss(e, 'position') && (r = !0),
                    (e = e.offsetParent);
            return (
                !0 === r &&
                    ((t += document.documentElement.scrollTop || document.body.scrollTop),
                    (i += document.documentElement.scrollLeft || document.body.scrollLeft)),
                { top: t, left: i, hidden: n }
            );
        }
        ...
        'object' == typeof window &&
            ('IntersectionObserver' in window && 'IntersectionObserverEntry' in window && 'intersectionRatio' in window.IntersectionObserverEntry.prototype
                ...
                : ((Gm = (function () {
                      for (var e = window.document, t = Fm(e); t; ) t = Fm((e = t.ownerDocument));
                      return e;
                  })()),
                  (Hm = []),
                  (Jm = Im = null),
                  (Lm.prototype.THROTTLE_TIMEOUT = 100),
                  (Lm.prototype.POLL_INTERVAL = null),
                  (Lm.prototype.USE_MUTATION_OBSERVER = !0),
                  (Lm._setupCrossOriginUpdater = function () {
                      return (Im =
                          Im ||
                          function (e, t) {
                              (Jm = e && t ? Um(e, t) : Sm()),
                  ...
                  (Lm._resetCrossOriginUpdater = function () {
                      Jm = Im = null;
                  }),
                  (Lm.prototype.observe = function (t) {
                      if (
                  ...
                  (Lm.prototype.unobserve = function (t) {
                  ...
                  (Lm.prototype.disconnect = function () {
                      (this._observationTargets = []), this._unmonitorAllIntersections(), this._unregisterInstance();
                  }),
                  (Lm.prototype.takeRecords = function () {
                      var e = this._queuedEntries.slice();
                      return (this._queuedEntries = []), e;
                  }),
                  (Lm.prototype._initThresholds = function (e) {
                      var t = e || [0];
                      return (
                          Array.isArray(t) || (t = [t]),
                  ...
                  (Lm.prototype._parseRootMargin = function (e) {
                  ...
                  (Lm.prototype._monitorIntersections = function (t) {
                      var i;
                      var n;
                      var r;
                      var e;
                          ...
                          this.POLL_INTERVAL
                              ...
                              : (Om(o, 'resize', i, !0),
                                ...
                                this.USE_MUTATION_OBSERVER &&
                                    ...
                                    (r = new o.MutationObserver(i)).observe(t, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })),
                          this._monitoringDocuments.push(t),
                          this._monitoringUnsubscribes.push(function () {
                              var e = t.defaultView;
                              e && (n && e.clearInterval(n), Pm(e, 'resize', i, !0)), Pm(t, 'scroll', i, !0), r && r.disconnect();
                          }),
                          t == ((this.root && this.root.ownerDocument) || Gm) || ((e = Fm(t)) && this._monitorIntersections(e.ownerDocument)));
                  }),
                  (Lm.prototype._unmonitorIntersections = function (n) {
                      var r;
                      var e;
                      var t;
                      var i = this._monitoringDocuments.indexOf(n);
                      -1 != i &&
                          ((r = (this.root && this.root.ownerDocument) || Gm),
                          this._observationTargets.some(function (e) {
                              ...
                              ((e = this._monitoringUnsubscribes[i]),
                              this._monitoringDocuments.splice(i, 1),
                              this._monitoringUnsubscribes.splice(i, 1),
                              e(),
                              n == r || ((t = Fm(n)) && this._unmonitorIntersections(t.ownerDocument))));
                  }),
                  (Lm.prototype._unmonitorAllIntersections = function () {
                      var e = this._monitoringUnsubscribes.slice(0);
                      this._monitoringDocuments.length = 0;
                      for (var t = (this._monitoringUnsubscribes.length = 0); t < e.length; t++) e[t]();
                  }),
                  (Lm.prototype._checkForIntersections = function () {
                      var s, l;
                      (!this.root && Im && !Jm) ||
                          ((s = this._rootIsInDom()),
                          (l = s ? this._getRootRect() : Sm()),
                          this._observationTargets.forEach(function (e) {
                              var t = e.element;
                              var i = Rm(t);
                              var n = this._rootContainsTarget(t);
                              var r = e.entry;
                              var o = s && n && this._computeTargetAndRootIntersection(t, i, l);
                              var a = (e.entry = new Km({
                                  time: window.performance && performance.now && performance.now(),
                                  target: t,
                                  boundingClientRect: i,
                                  rootBounds: Im && !this.root ? null : l,
                                  intersectionRect: o,
                              }));
                              r
                                  ? s && n
                                      ? this._hasCrossedThreshold(r, a) && this._queuedEntries.push(a)
                                      : r && r.isIntersecting && this._queuedEntries.push(a)
                                  : this._queuedEntries.push(a);
                          }, this),
                          this._queuedEntries.length && this._callback(this.takeRecords(), this));
                  }),
                  (Lm.prototype._computeTargetAndRootIntersection = function (e, t, i) {
                      if ('none' != window.getComputedStyle(e).display) {
                          for (var n, r, o, a, s, l, c, u, p = t, d = Wm(e), g = !1; !g && d; ) {
                              var f;
                              var m;
                              var y;
                              var h;
                              var b = null;
                              var v = 1 == d.nodeType ? window.getComputedStyle(d) : {};
                              if ('none' == v.display) return null;
                              if (
                                  (d == this.root || 9 == d.nodeType
                                      ? ((g = !0),
                                        d == this.root || d == Gm
                                            ? Im && !this.root
                                                ? !Jm || (0 == Jm.width && 0 == Jm.height)
                                                    ? (p = b = d = null)
                                                    : (b = Jm)
                                                : (b = i)
                                            : ((m = (f = Wm(d)) && Rm(f)),
                                              (y = f && this._computeTargetAndRootIntersection(f, m, i)),
                                              m && y ? ((d = f), (b = Um(m, y))) : (p = d = null)))
                                      : d != (h = d.ownerDocument).body && d != h.documentElement && 'visible' != v.overflow && (b = Rm(d)),
                                  b &&
                                      ((n = b),
                                      (r = p),
                                      0,
                                      ...
                                      (u = a - o),
                                      (p = 0 <= (c = l - s) && 0 <= u ? { top: o, bottom: a, left: s, right: l, width: c, height: u } : null)),
                                  !p)
                              )
                                  break;
                              d = d && Wm(d);
                  ...
                  (Lm.prototype._getRootRect = function () {
                      var e, t, i;
                      return (
                          (i = this.root
                              ? Rm(this.root)
                              : ((e = Gm.documentElement),
                                (t = Gm.body),
                                {
                                    top: 0,
                                    left: 0,
                  ...
                  (Lm.prototype._expandRectByRootMargin = function (i) {
                      var e = this._rootMarginValues.map(function (e, t) {
                          return 'px' == e.unit ? e.value : (e.value * (t % 2 ? i.width : i.height)) / 100;
                      });
                      var t = { top: i.top - e[0], right: i.right + e[1], bottom: i.bottom + e[2], left: i.left - e[3] };
                      return (t.width = t.right - t.left), (t.height = t.bottom - t.top), t;
                  }),
                  (Lm.prototype._hasCrossedThreshold = function (e, t) {
                      var i = e && e.isIntersecting ? e.intersectionRatio || 0 : -1;
                      var n = t.isIntersecting ? t.intersectionRatio || 0 : -1;
                      if (i !== n)
                  ...
                  (Lm.prototype._rootIsInDom = function () {
                      return !this.root || Vm(Gm, this.root);
                  }),
                  (Lm.prototype._rootContainsTarget = function (e) {
                      return Vm(this.root || Gm, e) && (!this.root || this.root.ownerDocument == e.ownerDocument);
                  }),
                  (Lm.prototype._registerInstance = function () {
                      Hm.indexOf(this) < 0 && Hm.push(this);
                  }),
                  (Lm.prototype._unregisterInstance = function () {
                      var e = Hm.indexOf(this);
                      -1 != e && Hm.splice(e, 1);
                  }),
                  (window.IntersectionObserver = Lm),
                  (window.IntersectionObserverEntry = Km)));
        var interval = null;
        var topValue = 0;
        function initWebStay() {
            ...
            function i() {
                ...
                topValue === e &&
                    ...
                    (interval = null),
                    window.AnalysysAgent && window.AnalysysAgent.freeApi
        ...
        function getChildEle(e) {
            for (var t = (e || document.body).childNodes, i = document.body, n = 0; n < t.length; n++)
                if (1 === t[n].nodeType) {
        ...
        function hasScrollbar(e) {
            ...
            return (
                (e ? ((t = e.scrollHeight), e.clientHeight) : ((t = document.body.scrollHeight), window.innerHeight || document.documentElement.clientHeight)) <
                    t && i < t
            );
        }
        var rootEle = null;
        ...
        function getRootEle(e) {
            ...
            !0 === e.autoHeatmap &&
                ...
                ((t = e.webstayRootEle) &&
                    ('String' === Util$1.paramType(t)
                        ? 0 < (i = Util$1.selectorAllEleList(t)).length && (n = i[0])
                        : 'Function' === Util$1.paramType(t)
                        ? (n = t.call(t) || null)
                        : 'object' == typeof t && 1 === t.nodeType && (n = t)),
                ((rootEle = n ? ((isRoot = !1), n) : getChildEle()) !== document.body && rootEle) || (rootEle = window),
                setRootEle(rootEle),
                initWebStay());
        }
        function autoWebstayInit(e) {
            return (
                -1 < window.location.href.indexOf('visual=true') ||
                    -1 < window.location.href.indexOf('arkheatmap=true') ||
                    (!1 === isElmentReady()
                        ? setTimeout(function () {
                              autoWebstayInit(e);
                          }, 300)
        ...
        var webstay = { __proto__: null, fieldRules: fieldRules$2, fieldTemplate: fieldTemplate$2, lifecycle: lifecycle$2 };
        var fieldRules$3 = {
        ...
        function loadHeatmapSDK() {
            document.body && document.getElementsByTagName('body')[0]
                ? (Util$1.addScript('AnalysysAgent_JS_SDK_HEATMAP', heatmapConfig.SDKFileDirectory), (window.ARK_HEATMAP = { config: heatmapConfig }))
        ...
        function addClickEvent(e) {
            ...
            var a;
            var s;
            var l = t.target || t.srcElement;
            Util$1.checkTypeList(heatmapConfig.heatMapBlackList, l) ||
                (heatmapConfig.heatMapWhiteList && !Util$1.checkTypeList(heatmapConfig.heatMapWhiteList, l)) ||
                ((i = document.documentElement.scrollLeft || document.body.scrollLeft),
                (n = document.documentElement.scrollTop || document.body.scrollTop),
                (r = t.pageX || t.clientX + i),
                (o = t.pageY || t.clientY + n),
                (elePostion.click_x = r),
                (elePostion.click_y = o),
                (elePostion.clickEle = elePostion.ele = l),
                getParentClickableElement(),
                (a = eleScroll(elePostion.ele)),
                (s = eleOffset$1(elePostion.ele)),
                (elePostion.elementX = r - (s.left - a.scrollLeft)),
                (elePostion.elementY = o - (s.top - a.scrollTop)),
                !r ||
                    !o ||
                    r <= 0 ||
                    o <= 0 ||
        ...
        function heatmapInit(e) {
            return (
                (heatmapConfig = e),
                -1 < window.location.href.indexOf('arkheatmap=true') || -1 < window.name.indexOf('arkheatmap=true')
                    ? ('' === window.name && (window.name = window.location.href), loadHeatmapSDK())
                    : !0 === e.autoHeatmap && !1 === e.isHybrid && initHeatmap(),
                e
            );
        }
        for (
            var lifecycle$3 = { AnalysysAgent: { init: heatmapInit } },
                heatmap = { __proto__: null, fieldRules: fieldRules$3, fieldTemplate: fieldTemplate$3, lifecycle: lifecycle$3 },
                fieldRules$4 = { xcontext: { $user_agent: { valueType: 1, value: encodeURIComponent(window.navigator.userAgent) } } },
                temp = {},
                event = ['$startup', '$track', '$pageview', '$webstay', '$web_click', '$errorLog', '$user_click'],
                common = { xcontext: ['$user_agent'] },
                i = 0;
            i < event.length;
            i++
        )
            temp[event[i]] = common;
        var ua = { __proto__: null, fieldRules: fieldRules$4, fieldTemplate: temp };
        var fieldRules$5 = {
            xcontext: {
                $page_width: { valueType: 0, value: getPageWidth },
                $page_height: { valueType: 0, value: getPageHeight },
        ...
        function addClickEvent$1(e) {
            ...
            if (
                !(
                    Util$1.checkTypeList(userClickConfig.autoClickBlackList, i) ||
                    (userClickConfig.autoClickWhiteList && !Util$1.checkTypeList(userClickConfig.autoClickWhiteList, i))
                ) &&
                ((elePostion.ele = i), getParentClickableElement(), 1 === getElementClickable())
            ) {
                ...
                if ('String' === Util$1.paramType(a))
                    try {
                        a = JSON.parse(a);
                    } catch (t) {}
                'Object' !== Util$1.paramType(a) && (a = {}),
                    'Object' === Util$1.paramType(r) && (a = Util$1.objMerge(r, a)),
                    window.AnalysysAgent.freeApi('$user_click', a);
            }
        }
        function addListenerUserClick() {
            'desktop' === Util$1.deviceType()
                ? Util$1.addEvent(document, 'mousedown', addClickEvent$1)
                : Util$1.addEvent(document, 'touchstart', addClickEvent$1);
        }
        function userClickInit(e) {
            return !0 === (userClickConfig = e).autoTrack && addListenerUserClick(), e;
        }
        for (
            var lifecycle$4 = { AnalysysAgent: { init: userClickInit } },
                userClick = { __proto__: null, fieldRules: fieldRules$5, fieldTemplate: fieldTemplate$4, lifecycle: lifecycle$4 },
                plugList = [visitor, webstay, heatmap, ua, userClick],
                fieldRules$6 = fieldRules || {},
                fieldTemplate$5 = fieldTemplate || {},
                lifecycle$5 = lifecycle || {},
                i$1 = 0;
            i$1 < plugList.length;
            i$1++
        )
            plugList[i$1].fieldRules && (fieldRules$6 = Util$1.objMerge(fieldRules$6, plugList[i$1].fieldRules)),
                plugList[i$1].fieldTemplate && (fieldTemplate$5 = Util$1.objMerge(fieldTemplate$5, plugList[i$1].fieldTemplate)),
                plugList[i$1].lifecycle && (lifecycle$5 = Util$1.fnMerge(lifecycle$5, plugList[i$1].lifecycle));
        for (var eventTemp = {}, commonTemp = {}, baseTemp = fieldTemplate$5.base, outerTemp = baseTemp.outer, i$2 = 0, keyTemp; i$2 < outerTemp.length; i$2++)
            baseTemp[outerTemp[i$2]] ? (commonTemp[outerTemp[i$2]] = Util$1.toObj(baseTemp[outerTemp[i$2]])) : (commonTemp[outerTemp[i$2]] = '');
        for (var key in fieldTemplate$5) {
            'base' !== key &&
                ((keyTemp = Util$1.toDeepObj(fieldTemplate$5[key])),
                (eventTemp[key + 'base'] = keyTemp),
                (eventTemp[key] = Util$1.objMerge(commonTemp, keyTemp)));
        }
        function temp$1(e) {
        ...
        (CheckField.prototype = Util$1),
            (CheckField.prototype.isString = function (e) {
            ...
            (CheckField.prototype.notSpecialCharacters = function (e) {
                return (
                    !(new RegExp('[\\u4E00-\\u9FA5]|[\\uFE30-\\uFFA0]', 'gi').test(e) || !/^[$a-zA-Z][a-zA-Z0-9_$]{0,}$/.test(e)) ||
            ...
            (CheckField.prototype.isArrayString = function (e) {
                if ('Array' === this.paramType(e))
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (!this.length255(e[t]))
                            return e[t] && 500 < e[t].length && (e[t] = Util$1.stringSlice(e[t], 499) + '$'), (baseConfig.status.value = e[t]), !1;
                    }
                return !0;
            }),
        ...
        function checkFields(e, t, i) {
            ...
            if (!n) return r;
            var o = n.key;
            var a = n.value || fieldRules$6.xcontextCommonRule.value;
            return (
                o && ((baseConfig.status.code = 200), (r = check(e, o)), (baseConfig.status.key = e), r || ((baseConfig.status.code = 400), errorLog())),
                a &&
                    ((baseConfig.status.code = 200),
                    (r = check(t, a)),
                    'Array' !== Util$1.paramType(t) && (baseConfig.status.value = t),
                    r || ((baseConfig.status.code = 400), errorLog())),
                r
            );
        }
        function resetCode() {
        ...
        function fillField(e, t) {
            ...
            for (var r in e) {
                ...
                l &&
                    ((o = ''),
                    'Object' === Util$1.paramType(s)
                        ? ((a = fillField(s, l)), (n[r] = a))
                        : Util$1.objHasKay(l, 'valueType') &&
                          (0 === l.valueType &&
                              ((o = l.value()), 'String' === Util$1.paramType(o) && 500 < o.length ? (n[r] = Util$1.stringSlice(o, 499) + '$') : (n[r] = o)),
                          1 === l.valueType &&
                              ((o = l.value), 'String' === Util$1.paramType(o) && 500 < o.length ? (n[r] = Util$1.stringSlice(o, 499) + '$') : (n[r] = o))));
            }
            return n;
        ...
        function clearCache(e) {
            if (!(e = e || !1)) {
                ...
                for (var i in t) {
                    'Object' !== Util$1.paramType(t[i]) &&
                        (('$debug' !== i && 'appid' !== i && 'uploadURL' !== i) ||
                            (Storage$1.getLocal('ANS' + i.toUpperCase()) !== t[i] && (e = !0), e && Storage$1.setLocal('ANS' + i.toUpperCase(), t[i])));
                }
            }
            return (
                e &&
        ...
        function isStartUp() {
            ...
            var i;
            var n;
            var r = Storage$1.getSession('STARTUP') || !1;
            var o = Storage$1.getCookie('ARK_STARTUP');
            return (
                '' !== document.referrer &&
                    o &&
                    !0 === baseConfig.base.cross_subdomain &&
                    ((t = (e = JSON.parse(Util$1.decode(decodeURIComponent(o)))).STARTUP),
                    (i = e.STARTUPTIME),
                    Storage$1.setSession('STARTUP', t),
                    Storage$1.setSession('STARTUPTIME', i),
                    (r = Storage$1.getSession('STARTUP') || !1)),
                !1 === r &&
                    ((n = Util$1.format(new Date(), 'yyyy-MM-dd hh:mm:ss.SSS')),
                    Storage$1.setSession('STARTUP', !0),
                    Storage$1.setSession('STARTUPTIME', n),
                    sessionId.setId(),
                    !0 === baseConfig.base.cross_subdomain &&
                        Storage$1.setCookie('ARK_STARTUP', encodeURIComponent(Util$1.encode(JSON.stringify({ STARTUP: !0, STARTUPTIME: n }))), 'session')),
                r
            );
        }
        function checkBase() {
            for (var e in baseConfig.base) {
                ...
                if (
                    ('$debug' === e && (t = fieldRules$6.xcontext[e]),
                    '$lib_version' === e && (t = fieldRules$6.xcontext[e]),
                    t && !checkFields(e, baseConfig.base[e], t))
                )
                    return void (baseConfig.base[e] = '');
                successLog();
            }
            return 1;
        }
        function checkPrivate(e, t, i) {
            ...
            if ('Object' !== Util$1.paramType(e) || !0 === i) {
                var r = n.check.key;
                var o = check(Util$1.trim(e), r);
                if (((baseConfig.status.key = e), !o)) return errorLog(), !1;
            } else
                for (var a in e) {
                    checkFields(a, e[a], n) ||
                        ('600019' === baseConfig.status.errorCode &&
                            'String' === Util$1.paramType(e[a]) &&
                            500 < e[a].length &&
                            (e[a] = Util$1.stringSlice(e[a], 499) + '$'));
                }
            return !0;
        }
        var postStatus = !0;
        ...
        function sendPost(e, t) {
            var i, n, a, r, o, s;
            (Util$1.GetUrlParam('visual') && -1 < Util$1.GetUrlParam('visual').indexOf('true')) ||
                ('img' !== sendType && (postStatus = !1),
                (i = e),
                'Array' === Util$1.paramType(e) && ((e = delRx(e)), (i = JSON.stringify(e))),
                window.AnalysysModal && 'function' == typeof window.AnalysysModal && window.AnalysysModal(e),
                (n = function n() {
                ...
                (o = e),
                (r = function (e) {
                    200 === e.code || 400 === e.code || 4200 === e.code
                        ? ((baseConfig.status.successCode = '20001'), successLog(), a(o), 'Function' === Util$1.paramType(t) && t.call(t))
                        : n();
                }),
                (s = { url: baseConfig.base.uploadURL + 'up?appid=' + baseConfig.base.appid, data: i, success: r, error: n }),
                successLog('Send message to server: ' + baseConfig.base.uploadURL + 'up?appid=' + baseConfig.base.appid + '\ndata:' + i),
                lifecycle$5.upload && lifecycle$5.upload.init
                    ? (s = lifecycle$5.upload.init(s))
                    : window.AnalysysModule &&
                      'Object' === Util$1.paramType(window.AnalysysModule) &&
                      'Function' === Util$1.paramType(window.AnalysysModule.uploadData) &&
                      (window.AnalysysModule.encryptInit(baseConfig.base), (s = window.AnalysysModule.uploadData(s))),
                'img' !== sendType ? ('post' === sendType || 'send' !== sendType ? new ajax().post(s) : snedGet(s, 'send')) : snedGet(s, 'img'));
        }
        function setValidKey(e) {
            var t = { data: e.data, send_type: '' };
            var i = [];
            ...
            var o = Util$1.MD5(r, 32).split('');
            var a = o[2] + '' + o[0] + o[4];
            return (t.send_type = a), t;
        }
        function snedGet(e, t) {
            if ('send' === t && navigator.sendBeacon) navigator.sendBeacon(e.url, e.data) && e.success({ code: 200 });
                ...
                (o.width = 1),
                    ...
                    'Number' === Util$1.paramType(baseConfig.base.sendDataTimeout) &&
        ...
        function checkSavaData(e) {
            var t = [];
            if ('Array' === Util$1.paramType(e) && 0 < e.length)
        ...
        function upLog(t, i) {
            try {
                baseConfig.base.sendType && (sendType = baseConfig.base.sendType),
                    '/' !== baseConfig.base.uploadURL.charAt(baseConfig.base.uploadURL.length - 1) && (baseConfig.base.uploadURL += '/');
                var n;
                var r = [];
                if (
                    ('img' === sendType
                        ? (r = checkSavaData(t))
                        : (0 === (n = checkSavaData((n = Storage$1.getLocal('POSTDATA') || []))).length && Storage$1.removeLocal('POSTDATA'),
                          (r = n).length < 500 ? r.push.apply(r, checkSavaData(t)) : (r = checkSavaData(t)),
                          Storage$1.setLocal('POSTDATA', r)),
                    !1 === postStatus && 'img' !== sendType)
                )
                    return void ('Function' === Util$1.paramType(i) && i.call(i));
                if (0 < r.length)
                    if ('img' === sendType) for (var o = 0; o < r.length; o++) 0 === o ? sendPost([r[o]], i) : sendPost([r[o]]);
                    else sendPost(r, i);
            } catch (e) {}
        }
        function loadIframeUrl(e, t) {
            var i;
            document.body
                ? ((i = document.createElement('iframe')).setAttribute('src', e),
                  i.setAttribute('id', 'AnalysysAgentIframe'),
        ...
        function transporter(e, t, i, n) {
            ...
            successLog('Send message to app: \ndata:' + o),
                !0 === window.AnalysysModule.moduleStatus
                    ? window.AnalysysModule.upData(r)
                    : window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.AnalysysAgent
                    ? postMessage(r)
                    : window.AnalysysAgentHybrid && window.AnalysysAgentHybrid.analysysHybridCallNative
                    ? callNative(o)
                    : loadIframeUrl('analysysagent:' + o),
                'Function' === Util$1.paramType(n) && n.call(n);
        }
        function backParamsArray() {
            for (var e = arguments, t = [], i = null, n = 0; n < e.length; n++)
                if (e[n] !== undefined) {
        ...
        function pageViewLog(e, t, i) {
            ...
            var o = i;
            window.AnalysysModule &&
                window.AnalysysModule.pageClose &&
                (!0 === pageCloseStatus ? window.AnalysysModule.pageClose.pageEndTrack() : (pageCloseStatus = !0),
                'String' === Util$1.paramType(n)
                    ? window.AnalysysModule.pageClose.createTime(+new Date(), n)
                    : window.AnalysysModule.pageClose.createTime(+new Date())),
                (baseConfig.status.FnName = '$pageview'),
                resetCode();
            var a = {};
            'String' === Util$1.paramType(n)
                ? checkPrivate((a = { $title: n }))
                : 'Object' === Util$1.paramType(n)
                ? ('Function' === Util$1.paramType(r) && (o = r), (r = n), (n = ''))
                : 'Function' === Util$1.paramType(n) && ((o = n), (n = r = '')),
                'Function' === Util$1.paramType(r) && ((o = r), (r = ''));
            var s = {};
            ...
            var u = Util$1.objMerge({ xcontext: c }, s);
            var u = Util$1.objMerge(u, { xcontext: a });
            var p = temp$1('$pageview');
            var d = Util$1.delEmpty(fillField(p));
            ...
            var f = backParamsArray(n || '', (g = Util$1.delNotHybrid(Util$1.delEmpty(g.xcontext))), o);
        ...
        function hashPageView() {
            Util$1.changeHash(function () {
                ...
                pageUrl !== window.location.href &&
                    ((pageUrl = window.location.href),
                    (e = !1),
                    ((baseConfig.base.pageViewWhiteList && Util$1.checkTypeList(baseConfig.base.pageViewWhiteList)) ||
                        !Util$1.checkTypeList(baseConfig.base.pageViewBlackList)) &&
                        (e = !0),
                    !0 === e && pageView());
            });
        }
        function track(e, t, i) {
            ...
            var l;
            var c = Storage$1.getLocal('ARKSUPER') || {};
            var u = Util$1.objMerge({ xcontext: c }, n);
            !0 !== baseConfig.base.isHybrid
                ? (((o = fillField(temp$1('$track'))).xcontext = Util$1.delEmpty(o.xcontext)), upLog(Util$1.objMerge(o, u), i))
                : ((a = fillField(temp$1('$trackbase'))),
                  (a = Util$1.delEmpty(a)),
                  (s = Util$1.objMerge(a, u)),
                  transporter('track', (l = backParamsArray(e, (s = Util$1.delNotHybrid(Util$1.delEmpty(s.xcontext))), i)).argArray, l.callback));
        }
        function freeApi(e, t) {
            ...
            o &&
                (!0 !== baseConfig.base.isHybrid
                    ? ((i = fillField(o)),
                      (n = Storage$1.getLocal('ARKSUPER') || {}),
                      'Object' === Util$1.paramType(t) && (n = Util$1.objMerge(n, t)),
                      (i = Util$1.objMerge(i, { xcontext: n })),
                      upLog(Util$1.delEmpty(i)))
                    : ((r = fillField(temp$1(e + 'base'))),
                      transporter('track', backParamsArray(e, Util$1.delNotHybrid(Util$1.delEmpty(r.xcontext))).argArray)));
        }
        ...
        function alias(e, t) {
            ...
            (baseConfig.status.FnName = '$alias'),
                resetCode(),
                !0 !== baseConfig.base.isHybrid
                    ? checkPrivate(e, '$alias', !0) &&
                      (Storage$1.setLocal('ARK_LOGINID', e),
                      (i = fillField(temp$1('$alias'))),
                      upLog(Util$1.delEmpty(i), t),
                      !0 === baseConfig.base.autoProfile &&
                          ((n = fillField(temp$1((baseConfig.status.FnName = '$profile_set_once')))),
                          (o = {
                          ...
                          (a = Util$1.objMerge(n, { xcontext: o })),
                          upLog(Util$1.delEmpty(a)),
                          Storage$1.setLocal('ARKFRISTPROFILE', r)))
                    : transporter('alias', (s = backParamsArray(e, '', t)).argArray, s.callback);
        }
        function identify(e, t, i) {
            ...
            (baseConfig.status.FnName = '$identify'),
                ...
                !0 !== baseConfig.base.isHybrid
                    ? checkPrivate(e, '$alias', !0) &&
                      ('Boolean' === Util$1.paramType(t) && !0 === t
                          ? Storage$1.setLocal('ARK_TRACK_LOGIN', !0)
                          : 'Function' === Util$1.paramType(t) && (i = t),
                      Storage$1.setLocal('ARK_TRACKID', e),
                      Storage$1.setCookie('ARK_ID', e),
                      (baseConfig.status.successCode = '20002'),
                      (baseConfig.status.value = e),
                      successLog(),
                      'Function' === Util$1.paramType(i) && i.call(i),
                      window.AnalysysModal && 'function' == typeof window.AnalysysModal && window.AnalysysModal([{ xwhat: '$identify', xwho: e }]))
        ...
        function profileSet(e, t, i) {
            (baseConfig.status.FnName = '$profile_set'),
                resetCode(),
                'Object' === Util$1.paramType(e) && 'Function' === Util$1.paramType(t)
                    ? ((i = t), (t = ''))
                    : 'String' === Util$1.paramType(e) && 'Function' === Util$1.paramType(t) && (t = t.call(t));
            var n;
            var r;
            var o;
            var a = Util$1.toObj(e, t);
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$profile_set'),
                  (n = temp$1('$profile_set')),
                  (r = Util$1.delEmpty(fillField(n))),
                  upLog(Util$1.objMerge(r, { xcontext: a }), i))
                : transporter('profileSet', (o = backParamsArray(e, t, i)).argArray, o.callback);
        }
        function profileSetOnce(e, t, i) {
            ...
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$profile_set_once'),
                  (n = temp$1('$profile_set_once')),
                  (r = Util$1.delEmpty(fillField(n))),
                  upLog(Util$1.objMerge(r, { xcontext: a }), i))
                : transporter('profileSetOnce', (o = backParamsArray(a, i)).argArray, o.callback);
        }
        function profileIncrement(e, t, i) {
            ...
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$profile_increment'),
                  (n = temp$1('$profile_increment')),
                  (r = Util$1.delEmpty(fillField(n))),
                  upLog(Util$1.objMerge(r, { xcontext: a }), i))
                : transporter('profileIncrement', (o = backParamsArray(e, t, i)).argArray, o.callback);
        }
        function profileAppend(e, t, i) {
            ...
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$profile_append'),
                  (n = temp$1('$profile_append')),
                  (r = Util$1.delEmpty(fillField(n))),
                  upLog(Util$1.objMerge(r, { xcontext: a }), i))
                : transporter('profileAppend', (o = backParamsArray(e, t, i)).argArray, o.callback);
        }
        function profileUnset(e, t) {
            (baseConfig.status.FnName = '$profile_unset'),
                resetCode(),
                'Function' === Util$1.paramType(e) && (e = e.call(e)),
                checkPrivate(e, '$profile_unset', e);
            var i;
            var n;
            var r = Util$1.toObj(e, '');
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(r, '$profile_unset'), (i = fillField(temp$1('$profile_unset'))), upLog(Util$1.objMerge(i, { xcontext: r }), t))
                : transporter('profileUnset', (n = backParamsArray(e, t)).argArray, n.callback);
        }
        function profileDelete(e) {
            (baseConfig.status.FnName = '$profile_delete'),
                resetCode(),
                !0 !== baseConfig.base.isHybrid ? upLog(fillField(temp$1('$profile_delete')), e) : transporter('profileDelete', [], e);
        }
        function registerSuperProperty(e, t, i) {
            ...
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$registerSuperProperty'),
                  (n = Storage$1.getLocal('ARKSUPER') || {}),
                  (r = Util$1.objMerge(n, a)),
                  Storage$1.setLocal('ARKSUPER', r),
                  (baseConfig.status.successCode = '20002'),
                  (baseConfig.status.value = JSON.stringify(a)),
                  successLog(),
                  'Function' === Util$1.paramType(i) && i.call(i))
                : transporter('registerSuperProperty', (o = backParamsArray(e, t, i)).argArray, o.callback);
        }
        function registerSuperProperties(e, t, i) {
            ...
            for (var s in a) 'Function' === Util$1.paramType(a[s]) && (a[s] = a[s].call(a[s]));
            !0 !== baseConfig.base.isHybrid
                ? (checkPrivate(a, '$registerSuperProperties'),
                  (n = Storage$1.getLocal('ARKSUPER') || {}),
                  (r = Util$1.objMerge(n, a)),
                  Storage$1.setLocal('ARKSUPER', r),
                  (baseConfig.status.successCode = '20002'),
                  ...
                  successLog(),
                  'Function' === Util$1.paramType(i) && i.call(i))
                : transporter('registerSuperProperties', (o = backParamsArray(e, t, i)).argArray, o.callback);
        }
        function getSuperProperty(e, t) {
            ...
            return (
                !{}.hasOwnProperty.call(r, e)
                    ? ((baseConfig.status.successCode = '20009'), (o = ''))
                    : ((baseConfig.status.successCode = '20010'), (baseConfig.status.value = o)),
                (baseConfig.status.key = e),
                successLog(),
                'Function' === Util$1.paramType(t) && t.call(t, o),
                o
            );
        }
        function getSuperProperties(e) {
            ...
            return (
                ...
                (baseConfig.status.value = JSON.stringify(i)),
                successLog(),
                'Function' === Util$1.paramType(e) && e.call(e, i),
                i
            );
        }
            ...
            (baseConfig.status.FnName = '$unregisterSuperProperty'),
                ...
                !0 !== baseConfig.base.isHybrid
                    ? (checkPrivate(e, '$unregisterSuperProperty', !0),
                      (i = Storage$1.getLocal('ARKSUPER') || {}),
                      Object.prototype.hasOwnProperty.call(i, e)
                          ? (delete i[e], Storage$1.setLocal('ARKSUPER', i), (baseConfig.status.successCode = '20003'))
                          : (baseConfig.status.successCode = '20011'),
                      (baseConfig.status.value = e),
                      successLog(),
                      'Function' === Util$1.paramType(t) && t.call(t))
                    : transporter('unRegisterSuperProperty', (n = backParamsArray.apply(e, arguments)).argArray, n.callback);
        }
            ...
            (baseConfig.status.FnName = '$clearSuperProperties'),
                ...
                !0 !== baseConfig.base.isHybrid
                    ? (Storage$1.setLocal('ARKSUPER', {}),
                      ...
                      successLog(),
                      'Function' === Util$1.paramType(e) && e.call(e))
                    : transporter('clearSuperProperties', (t = backParamsArray(e)).argArray, t.callback);
        }
        function reset(e) {
            !0 !== baseConfig.base.isHybrid
                ? (resetCode(),
                  ...
                  sessionId.setId(),
                  !0 === baseConfig.base.autoProfile
                      ? profileSetOnce({ $reset_time: Util$1.format(new Date(), 'yyyy-MM-dd hh:mm:ss.SSS') }, e)
                      : 'Function' === Util$1.paramType(e) && e.call(e),
        ...
        function startUp() {
            ...
            var c;
            var u = [];
            !1 !== baseConfig.base.isHybrid || checkBase()
                ? ((e = Storage$1.getLocal('ARKSUPER') || {}),
                  !1 === baseConfig.base.isHybrid &&
                      !1 === isStartUp() &&
                      ((t = !0),
                      (Util$1.checkTypeList(baseConfig.base.startUpBlackList) ||
                          (baseConfig.base.startUpWhiteList && !Util$1.checkTypeList(baseConfig.base.startUpWhiteList))) &&
                          (t = !1),
                      !0 === t &&
                          ((i = fillField(temp$1((baseConfig.status.FnName = '$startup')))),
                          (i = Util$1.objMerge(i, { xcontext: e })),
                          u.push(Util$1.delEmpty(i)))),
                  (n = Storage$1.getLocal('ARKFRISTPROFILE') || !1),
                  !1 !== baseConfig.base.isHybrid ||
                      !0 !== baseConfig.base.autoProfile ||
                      n ||
                      ((r = fillField(temp$1((baseConfig.status.FnName = '$profile_set_once')))),
                      (a = {
                          $first_visit_time: (o = Storage$1.getLocal('ARKFRISTPROFILE') || Util$1.format(new Date(), 'yyyy-MM-dd hh:mm:ss.SSS')),
                          $first_visit_language: (navigator.language || navigator.browserLanguage).toLowerCase(),
                      }),
                      (s = Util$1.objMerge(r, { xcontext: a })),
                      u.push(Util$1.delEmpty(s)),
                      Storage$1.setLocal('ARKFRISTPROFILE', o)),
                  !0 === baseConfig.base.auto &&
                      ((l = !1),
                      ((baseConfig.base.pageViewWhiteList && Util$1.checkTypeList(baseConfig.base.pageViewWhiteList)) ||
                          !Util$1.checkTypeList(baseConfig.base.pageViewBlackList)) &&
                          (l = !0),
                      !0 === l && ((c = pageViewLog(baseConfig.base.pageProperty)), u.push(c)),
                      (!0 !== baseConfig.base.hash && !0 !== baseConfig.base.singlePage) || hashPageView()),
                  0 < u.length && upLog(u))
                : errorLog();
        }
        function ieCreat() {
        ...
        if (!0 !== AnalysysAgent.isInit)
            for (var key$1 in ans)
                AnalysysAgent[key$1] = (function (t) {
                    return function () {
                        var e = arguments;
        ...
        function isHybrid() {
            -1 < window.navigator.userAgent.indexOf('AnalysysAgent/Hybrid') && (baseConfig.base.isHybrid = !0),
                window.AnalysysAgentHybrid && !0 === window.AnalysysAgentHybrid.isHybrid() && (baseConfig.base.isHybrid = !0),
                AnalysysModule && !0 === AnalysysModule.moduleStatus && AnalysysModule.isHybrid();
        }
        function _createAnsSDK() {
            ...
            if (!0 === baseConfig.base.isHybrid)
                for (var i in HybridAns) AnalysysAgent[i] = !0 === AnalysysModule.moduleStatus ? AnalysysModule.onEvent(i, HybridAns) : HybridAns[i];
        ...
        if (
            (ieCreat(),
            isHybrid(),
            (AnalysysAgent.init = function (e) {
                'Object' !== Util$1.paramType(config) ||
                    (AnalysysAgent.isInit && !0 !== baseConfig.base.isHybrid) ||
                    (AnalysysModule.moduleStatus && (!0 !== AnalysysModule.moduleStatus || (!0 !== e.isHybrid && !0 !== e.isARKH5))) ||
                    (!0 !== e.isARKH5 && (config = e), _createAnsSDK());
            }),
            !AnalysysAgent.isInit)
        ) {
            if ('Array' === Util$1.paramType(AnalysysAgent))
                for (var i$3 = 0, fnName; i$3 < AnalysysAgent.length; i$3++) {
                    'Function' === Util$1.paramType(ans[AnalysysAgent[i$3][0]])
                        ? ((fnName = AnalysysAgent[i$3][0]), AnalysysAgent[i$3].splice(0, 1), param.push([fnName, AnalysysAgent[i$3]]))
                        : (config[AnalysysAgent[i$3][0]] = AnalysysAgent[i$3][1]);
                }
